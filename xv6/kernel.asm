...
80100409:	e8 92 55 00 00       	call   801059a0 <uartputc>
}
...
801004b9:	e8 e2 54 00 00       	call   801059a0 <uartputc>
801004be:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004c5:	e8 d6 54 00 00       	call   801059a0 <uartputc>
801004ca:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004d1:	e8 ca 54 00 00       	call   801059a0 <uartputc>
...
80100a2a:	75 d4                	jne    80100a00 <exec+0x60>
  ...
  if((pgdir = setupkvm()) == 0)
80100a2c:	e8 5f 61 00 00       	call   80106b90 <setupkvm>
...
80100ad2:	e8 29 5f 00 00       	call   80106a00 <allocuvm>
...
80100b13:	e8 28 5e 00 00       	call   80106940 <loaduvm>
...
80100b29:	e8 e2 5f 00 00       	call   80106b10 <freevm>
...
80100b6c:	e8 8f 5e 00 00       	call   80106a00 <allocuvm>
...
80100b84:	e8 87 5f 00 00       	call   80106b10 <freevm>
  if(ip){
    iunlockput(ip);
    end_op();
  }
...
80100b93:	e8 f8 1f 00 00       	call   80102b90 <end_op>
    cprintf("exec: fail\n");
80100b98:	c7 04 24 c1 6e 10 80 	movl   $0x80106ec1,(%esp)
...
80100bc8:	e8 73 60 00 00       	call   80106c40 <clearpteu>
  sp = sz;
...
80100c31:	e8 6a 61 00 00       	call   80106da0 <copyout>
...
80100c9e:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca4:	e8 f7 60 00 00       	call   80106da0 <copyout>
...
80100d1f:	e8 8c 5a 00 00       	call   801067b0 <switchuvm>
  freevm(oldpgdir);
80100d24:	89 34 24             	mov    %esi,(%esp)
80100d27:	e8 e4 5d 00 00       	call   80106b10 <freevm>
  return 0;
...
80102db7:	e8 14 29 00 00       	call   801056d0 <idtinit>
...
80102de3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102de6:	e8 a5 39 00 00       	call   80106790 <switchkvm>
  seginit();
80102deb:	e8 e0 38 00 00       	call   801066d0 <seginit>
  lapicinit();
...
80102e23:	e8 f8 3d 00 00       	call   80106c20 <kvmalloc>
...
80102e35:	e8 96 38 00 00       	call   801066d0 <seginit>
  picinit();       // disable pic
...
80102e4a:	e8 a1 2b 00 00       	call   801059f0 <uartinit>
80102e4f:	90                   	nop
  pinit();         // process table
80102e50:	e8 9b 07 00 00       	call   801035f0 <pinit>
  tvinit();        // trap vectors
80102e55:	e8 d6 27 00 00       	call   80105630 <tvinit>
  binit();         // buffer cache
...
8010353d:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103540:	c7 40 14 25 56 10 80 	movl   $0x80105625,0x14(%eax)
...
801036f3:	e8 98 34 00 00       	call   80106b90 <setupkvm>
...
80103715:	80 
80103716:	e8 a5 31 00 00       	call   801068c0 <inituvm>
  p->sz = PGSIZE;
...
80103792:	00 
80103793:	c7 44 24 04 c5 73 10 	movl   $0x801073c5,0x4(%esp)
8010379a:	80 
8010379b:	89 04 24             	mov    %eax,(%esp)
8010379e:	e8 dd 0e 00 00       	call   80104680 <safestrcpy>
  p->cwd = namei("/");
801037a3:	c7 04 24 ce 73 10 80 	movl   $0x801073ce,(%esp)
...
801037d6:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
801037d7:	c7 04 24 ac 73 10 80 	movl   $0x801073ac,(%esp)
...
80103819:	e8 e2 31 00 00       	call   80106a00 <allocuvm>
...
80103827:	e8 84 2f 00 00       	call   801067b0 <switchuvm>
  return 0;
...
8010384a:	e8 a1 32 00 00       	call   80106af0 <deallocuvm>
...
8010388e:	e8 dd 33 00 00       	call   80106c70 <copyuvm>
...
801039c2:	83 eb 80             	sub    $0xffffff80,%ebx
      ...
      c->proc = p;
      switchuvm(p);
801039c5:	e8 e6 2d 00 00       	call   801067b0 <switchuvm>
      p->state = RUNNING;
...
801039db:	e8 fb 0c 00 00       	call   801046db <swtch>
      switchkvm();
801039e0:	e8 ab 2d 00 00       	call   80106790 <switchkvm>
    // Enable interrupts on this processor.
    sti();
...
80103cce:	e8 3d fd ff ff       	call   80103a10 <sched>
  panic("zombie exit");
80103cd3:	c7 04 24 1d 74 10 80 	movl   $0x8010741d,(%esp)
...
// Store status
  ...
  if(curproc == initproc)
    panic("init exiting");
80103cdf:	c7 04 24 10 74 10 80 	movl   $0x80107410,(%esp)
...
80103dbe:	c7 04 24 2f 74 10 80 	movl   $0x8010742f,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  if(p == 0)
    panic("sleep");
80103dca:	c7 04 24 29 74 10 80 	movl   $0x80107429,(%esp)
...
80103e68:	e8 a3 2c 00 00       	call   80106b10 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
80103f48:	e8 c3 2b 00 00       	call   80106b10 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
801040a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
801040a8:	c7 04 24 bf 77 10 80 	movl   $0x801077bf,(%esp)
...
801040ca:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
801040cd:	ba 40 74 10 80       	mov    $0x80107440,%edx
  uint pc[10];
...
801040d4:	8b 14 85 a0 74 10 80 	mov    -0x7fef8b60(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
801040db:	b8 40 74 10 80       	mov    $0x80107440,%eax
...
801040f0:	c7 04 24 44 74 10 80 	movl   $0x80107444,(%esp)
...
80104139:	c7 04 24 81 6e 10 80 	movl   $0x80106e81,(%esp)
...
8010416a:	c7 44 24 04 b8 74 10 	movl   $0x801074b8,0x4(%esp)
80104171:	80 
...
801043c7:	eb ac                	jmp    80104375 <acquire+0x15>
    panic("acquire");
801043c9:	c7 04 24 c3 74 10 80 	movl   $0x801074c3,(%esp)
...
popcli(void)
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
8010442a:	c7 04 24 e2 74 10 80 	movl   $0x801074e2,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80104436:	c7 04 24 cb 74 10 80 	movl   $0x801074cb,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
80104461:	c7 04 24 e9 74 10 80 	movl   $0x801074e9,(%esp)
...
8010487d:	8b 14 85 20 75 10 80 	mov    -0x7fef8ae0(,%eax,4),%edx
...
801048a6:	c7 04 24 f1 74 10 80 	movl   $0x801074f1,(%esp)
...
80104a30:	c7 44 24 04 9c 75 10 	movl   $0x8010759c,0x4(%esp)
80104a37:	80 
...
80104a4b:	c7 44 24 04 9b 75 10 	movl   $0x8010759b,0x4(%esp)
80104a52:	80 
...
80104a61:	79 89                	jns    801049ec <create+0xdc>
      panic("create dots");
80104a63:	c7 04 24 8f 75 10 80 	movl   $0x8010758f,(%esp)
80104a6a:	e8 f1 b8 ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
80104a6f:	c7 04 24 9e 75 10 80 	movl   $0x8010759e,(%esp)
80104a76:	e8 e5 b8 ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
80104a7b:	c7 04 24 80 75 10 80 	movl   $0x80107580,(%esp)
...
80104e21:	c7 44 24 04 9c 75 10 	movl   $0x8010759c,0x4(%esp)
80104e28:	80 
...
80104e39:	c7 44 24 04 9b 75 10 	movl   $0x8010759b,0x4(%esp)
80104e40:	80 
...
80104f88:	e9 48 ff ff ff       	jmp    80104ed5 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104f8d:	c7 04 24 c0 75 10 80 	movl   $0x801075c0,(%esp)
80104f94:	e8 c7 b3 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104f99:	c7 04 24 d2 75 10 80 	movl   $0x801075d2,(%esp)
80104fa0:	e8 bb b3 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104fa5:	c7 04 24 ae 75 10 80 	movl   $0x801075ae,(%esp)
...
{
  return wait();
80105454:	e9 87 e9 ff ff       	jmp    80103de0 <wait>
...
80105469:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80105470:	00 
80105471:	89 44 24 04          	mov    %eax,0x4(%esp)
80105475:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010547c:	e8 3f f3 ff ff       	call   801047c0 <argptr>
    return -1;
  return nwait(status);
}
...
801054a4:	e8 e7 f2 ff ff       	call   80104790 <argint>
801054a9:	85 c0                	test   %eax,%eax
801054ab:	78 13                	js     801054c0 <sys_kill+0x30>
    return -1;
  return kill(pid);
801054ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054b0:	89 04 24             	mov    %eax,(%esp)
801054b3:	e8 58 eb ff ff       	call   80104010 <kill>
}
801054b8:	c9                   	leave  
801054b9:	c3                   	ret    
...
801054d3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801054d6:	e8 d5 e1 ff ff       	call   801036b0 <myproc>
...
801054fc:	78 22                	js     80105520 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801054fe:	e8 ad e1 ff ff       	call   801036b0 <myproc>
  if(growproc(n) < 0)
80105503:	8b 55 f4             	mov    -0xc(%ebp),%edx
  int addr;
  int n;
  ...
  if(argint(0, &n) < 0)
    return -1;
  addr = myproc()->sz;
80105506:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105508:	89 14 24             	mov    %edx,(%esp)
8010550b:	e8 e0 e2 ff ff       	call   801037f0 <growproc>
80105510:	85 c0                	test   %eax,%eax
80105512:	78 0c                	js     80105520 <sys_sbrk+0x40>
    return -1;
  return addr;
80105514:	89 d8                	mov    %ebx,%eax
}
80105516:	83 c4 24             	add    $0x24,%esp
80105519:	5b                   	pop    %ebx
8010551a:	5d                   	pop    %ebp
8010551b:	c3                   	ret    
...
80105525:	eb ef                	jmp    80105516 <sys_sbrk+0x36>
...
80105545:	e8 46 f2 ff ff       	call   80104790 <argint>
8010554a:	85 c0                	test   %eax,%eax
8010554c:	78 7e                	js     801055cc <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010554e:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105555:	e8 06 ee ff ff       	call   80104360 <acquire>
  ticks0 = ticks;
...
8010555a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  acquire(&tickslock);
  ticks0 = ticks;
8010555d:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
...
80105570:	c7 44 24 04 60 4d 11 	movl   $0x80114d60,0x4(%esp)
80105577:	80 
80105578:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
8010557f:	e8 ac e7 ff ff       	call   80103d30 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105584:	a1 a0 55 11 80       	mov    0x801155a0,%eax
...
8010559a:	74 d4                	je     80105570 <sys_sleep+0x40>
      release(&tickslock);
8010559c:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801055a3:	e8 a8 ee ff ff       	call   80104450 <release>
      return -1;
...
801055ad:	83 c4 24             	add    $0x24,%esp
801055b0:	5b                   	pop    %ebx
801055b1:	5d                   	pop    %ebp
801055b2:	c3                   	ret    
801055b3:	90                   	nop
801055b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&tickslock);
801055b8:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801055bf:	e8 8c ee ff ff       	call   80104450 <release>
  return 0;
}
...
801055d1:	eb da                	jmp    801055ad <sys_sleep+0x7d>
...
801055ee:	e8 6d ed ff ff       	call   80104360 <acquire>
  xticks = ticks;
801055f3:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
801055f9:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105600:	e8 4b ee ff ff       	call   80104450 <release>
  return xticks;
}
...
8010560e:	06                   	push   %es
  pushl %fs
8010560f:	0f a0                	push   %fs
  pushl %gs
80105611:	0f a8                	push   %gs
  pushal
80105613:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105614:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105618:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010561a:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010561c:	54                   	push   %esp
  call trap
8010561d:	e8 de 00 00 00       	call   80105700 <trap>
  addl $4, %esp
80105622:	83 c4 04             	add    $0x4,%esp
...
80105625:	61                   	popa   
  popl %gs
80105626:	0f a9                	pop    %gs
  popl %fs
80105628:	0f a1                	pop    %fs
  popl %es
8010562a:	07                   	pop    %es
  popl %ds
8010562b:	1f                   	pop    %ds
...
80105644:	66 89 0c c5 a2 4d 11 	mov    %cx,-0x7feeb25e(,%eax,8)
8010564b:	80 
8010564c:	c6 04 c5 a4 4d 11 80 	movb   $0x0,-0x7feeb25c(,%eax,8)
80105653:	00 
...
80105689:	c7 44 24 04 e1 75 10 	movl   $0x801075e1,0x4(%esp)
80105690:	80 
80105691:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105698:	66 89 15 a2 4f 11 80 	mov    %dx,0x80114fa2
8010569f:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
801056a5:	c1 e8 10             	shr    $0x10,%eax
801056a8:	c6 05 a4 4f 11 80 00 	movb   $0x0,0x80114fa4
801056af:	c6 05 a5 4f 11 80 ef 	movb   $0xef,0x80114fa5
801056b6:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6

  initlock(&tickslock, "time");
801056bc:	e8 af eb ff ff       	call   80104270 <initlock>
}
801056c1:	c9                   	leave  
801056c2:	c3                   	ret    
...
80105712:	0f 84 a0 01 00 00    	je     801058b8 <trap+0x1b8>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105720:	ff 24 85 88 76 10 80 	jmp    *-0x7fef8978(,%eax,4)
80105727:	90                   	nop
    lapiceoi();
    break;
...
8010572f:	90                   	nop
80105730:	0f 84 fa 01 00 00    	je     80105930 <trap+0x230>
80105736:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010573a:	0f 84 f0 01 00 00    	je     80105930 <trap+0x230>
...
8010574c:	e8 3f df ff ff       	call   80103690 <cpuid>
...
80105764:	e8 47 df ff ff       	call   801036b0 <myproc>
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105769:	8b 55 dc             	mov    -0x24(%ebp),%edx
...
80105770:	8b 75 e0             	mov    -0x20(%ebp),%esi
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105773:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105776:	89 7c 24 14          	mov    %edi,0x14(%esp)
8010577a:	89 54 24 18          	mov    %edx,0x18(%esp)
8010577e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105781:	83 c6 6c             	add    $0x6c,%esi
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105784:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105788:	89 74 24 08          	mov    %esi,0x8(%esp)
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010578c:	89 54 24 10          	mov    %edx,0x10(%esp)
80105790:	8b 40 10             	mov    0x10(%eax),%eax
80105793:	c7 04 24 44 76 10 80 	movl   $0x80107644,(%esp)
...
8010579e:	e8 ad ae ff ff       	call   80100650 <cprintf>
    ...
    myproc()->killed = 1;
801057a3:	e8 08 df ff ff       	call   801036b0 <myproc>
...
801057b9:	e8 f2 de ff ff       	call   801036b0 <myproc>
...
801057c5:	e8 e6 de ff ff       	call   801036b0 <myproc>
...
801057d9:	74 4d                	je     80105828 <trap+0x128>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801057db:	e8 d0 de ff ff       	call   801036b0 <myproc>
801057e0:	85 c0                	test   %eax,%eax
801057e2:	74 1d                	je     80105801 <trap+0x101>
801057e4:	e8 c7 de ff ff       	call   801036b0 <myproc>
...
801057fb:	0f 84 e8 00 00 00    	je     801058e9 <trap+0x1e9>
    exit();
}
...
8010581b:	75 a8                	jne    801057c5 <trap+0xc5>
    exit();    
8010581d:	e8 8e e2 ff ff       	call   80103ab0 <exit>
...
80105830:	75 a9                	jne    801057db <trap+0xdb>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105832:	e8 b9 e4 ff ff       	call   80103cf0 <yield>
80105837:	eb a2                	jmp    801057db <trap+0xdb>
80105839:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105840:	e8 4b de ff ff       	call   80103690 <cpuid>
80105845:	85 c0                	test   %eax,%eax
80105847:	0f 84 b3 00 00 00    	je     80105900 <trap+0x200>
8010584d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80105850:	e8 3b cf ff ff       	call   80102790 <lapiceoi>
    break;
...
80105860:	e8 7b cd ff ff       	call   801025e0 <kbdintr>
    lapiceoi();
80105865:	e8 26 cf ff ff       	call   80102790 <lapiceoi>
    break;
8010586a:	e9 41 ff ff ff       	jmp    801057b0 <trap+0xb0>
8010586f:	90                   	nop
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80105870:	e8 1b 02 00 00       	call   80105a90 <uartintr>
    lapiceoi();
80105875:	e8 16 cf ff ff       	call   80102790 <lapiceoi>
    break;
8010587a:	e9 31 ff ff ff       	jmp    801057b0 <trap+0xb0>
8010587f:	90                   	nop
  case T_IRQ0 + 7:
...
80105887:	e8 04 de ff ff       	call   80103690 <cpuid>
8010588c:	c7 04 24 ec 75 10 80 	movl   $0x801075ec,(%esp)
...
8010589f:	e8 ac ad ff ff       	call   80100650 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
801058a4:	e8 e7 ce ff ff       	call   80102790 <lapiceoi>
    break;
801058a9:	e9 02 ff ff ff       	jmp    801057b0 <trap+0xb0>
801058ae:	66 90                	xchg   %ax,%ax
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801058b0:	e8 db c7 ff ff       	call   80102090 <ideintr>
801058b5:	eb 96                	jmp    8010584d <trap+0x14d>
801058b7:	90                   	nop
801058b8:	90                   	nop
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
801058c0:	e8 eb dd ff ff       	call   801036b0 <myproc>
801058c5:	8b 70 24             	mov    0x24(%eax),%esi
801058c8:	85 f6                	test   %esi,%esi
801058ca:	75 2c                	jne    801058f8 <trap+0x1f8>
      exit();
    myproc()->tf = tf;
801058cc:	e8 df dd ff ff       	call   801036b0 <myproc>
801058d1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801058d4:	e8 87 ef ff ff       	call   80104860 <syscall>
    if(myproc()->killed)
801058d9:	e8 d2 dd ff ff       	call   801036b0 <myproc>
801058de:	8b 48 24             	mov    0x24(%eax),%ecx
801058e1:	85 c9                	test   %ecx,%ecx
801058e3:	0f 84 18 ff ff ff    	je     80105801 <trap+0x101>
    yield();
...
801058e9:	83 c4 3c             	add    $0x3c,%esp
801058ec:	5b                   	pop    %ebx
801058ed:	5e                   	pop    %esi
801058ee:	5f                   	pop    %edi
801058ef:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
801058f0:	e9 bb e1 ff ff       	jmp    80103ab0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
801058f8:	e8 b3 e1 ff ff       	call   80103ab0 <exit>
801058fd:	eb cd                	jmp    801058cc <trap+0x1cc>
801058ff:	90                   	nop
  }
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
80105900:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105907:	e8 54 ea ff ff       	call   80104360 <acquire>
      ticks++;
      wakeup(&ticks);
8010590c:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105913:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
8010591a:	e8 91 e6 ff ff       	call   80103fb0 <wakeup>
      release(&tickslock);
8010591f:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105926:	e8 25 eb ff ff       	call   80104450 <release>
8010592b:	e9 1d ff ff ff       	jmp    8010584d <trap+0x14d>
80105930:	0f 20 d7             	mov    %cr2,%edi
  ...
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
      ...
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105933:	8b 73 38             	mov    0x38(%ebx),%esi
80105936:	e8 55 dd ff ff       	call   80103690 <cpuid>
8010593b:	89 7c 24 10          	mov    %edi,0x10(%esp)
8010593f:	89 74 24 0c          	mov    %esi,0xc(%esp)
80105943:	89 44 24 08          	mov    %eax,0x8(%esp)
80105947:	8b 43 30             	mov    0x30(%ebx),%eax
8010594a:	c7 04 24 10 76 10 80 	movl   $0x80107610,(%esp)
80105951:	89 44 24 04          	mov    %eax,0x4(%esp)
80105955:	e8 f6 ac ff ff       	call   80100650 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
8010595a:	c7 04 24 e6 75 10 80 	movl   $0x801075e6,(%esp)
80105961:	e8 fa a9 ff ff       	call   80100360 <panic>
...
8010597a:	74 14                	je     80105990 <uartgetc+0x20>
static inline uchar
inb(ushort port)
{
  uchar data;
...
80105984:	74 0a                	je     80105990 <uartgetc+0x20>
80105986:	b2 f8                	mov    $0xf8,%dl
...
801059a7:	74 3f                	je     801059e8 <uartputc+0x48>
    uartputc(*p);
}
...
801059b2:	53                   	push   %ebx
  ...
  if(!uart)
801059b3:	bb 80 00 00 00       	mov    $0x80,%ebx
    uartputc(*p);
}
...
801059bb:	eb 14                	jmp    801059d1 <uartputc+0x31>
801059bd:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
    microdelay(10);
801059c0:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801059c7:	e8 e4 cd ff ff       	call   801027b0 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801059cc:	83 eb 01             	sub    $0x1,%ebx
801059cf:	74 07                	je     801059d8 <uartputc+0x38>
801059d1:	89 f2                	mov    %esi,%edx
801059d3:	ec                   	in     (%dx),%al
801059d4:	a8 20                	test   $0x20,%al
801059d6:	74 e8                	je     801059c0 <uartputc+0x20>
    microdelay(10);
  outb(COM1+0, c);
801059d8:	0f b6 45 08          	movzbl 0x8(%ebp),%eax
}
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801059dc:	ba f8 03 00 00       	mov    $0x3f8,%edx
...
801059f5:	89 c8                	mov    %ecx,%eax
801059f7:	57                   	push   %edi
801059f8:	bf fa 03 00 00       	mov    $0x3fa,%edi
801059fd:	56                   	push   %esi
801059fe:	89 fa                	mov    %edi,%edx
80105a00:	53                   	push   %ebx
80105a01:	83 ec 1c             	sub    $0x1c,%esp
80105a04:	ee                   	out    %al,(%dx)
80105a05:	be fb 03 00 00       	mov    $0x3fb,%esi
80105a0a:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
80105a0f:	89 f2                	mov    %esi,%edx
80105a11:	ee                   	out    %al,(%dx)
80105a12:	b8 0c 00 00 00       	mov    $0xc,%eax
80105a17:	b2 f8                	mov    $0xf8,%dl
80105a19:	ee                   	out    %al,(%dx)
80105a1a:	bb f9 03 00 00       	mov    $0x3f9,%ebx
80105a1f:	89 c8                	mov    %ecx,%eax
80105a21:	89 da                	mov    %ebx,%edx
80105a23:	ee                   	out    %al,(%dx)
80105a24:	b8 03 00 00 00       	mov    $0x3,%eax
80105a29:	89 f2                	mov    %esi,%edx
80105a2b:	ee                   	out    %al,(%dx)
80105a2c:	b2 fc                	mov    $0xfc,%dl
80105a2e:	89 c8                	mov    %ecx,%eax
80105a30:	ee                   	out    %al,(%dx)
80105a31:	b8 01 00 00 00       	mov    $0x1,%eax
...
80105a3b:	ec                   	in     (%dx),%al
  ...
  if(inb(COM1+5) == 0xFF)
80105a3c:	3c ff                	cmp    $0xff,%al
80105a3e:	74 42                	je     80105a82 <uartinit+0x92>
    return;
  uart = 1;
80105a40:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80105a47:	00 00 00 
80105a4a:	89 fa                	mov    %edi,%edx
80105a4c:	ec                   	in     (%dx),%al
80105a4d:	b2 f8                	mov    $0xf8,%dl
80105a4f:	ec                   	in     (%dx),%al
...
80105a50:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105a57:	00 

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80105a58:	bb 08 77 10 80       	mov    $0x80107708,%ebx
  ...
  inb(COM1+0);
  ioapicenable(IRQ_COM1, 0);
80105a5d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105a64:	e8 57 c8 ff ff       	call   801022c0 <ioapicenable>
...
80105a73:	83 c3 01             	add    $0x1,%ebx
    uartputc(*p);
80105a76:	e8 25 ff ff ff       	call   801059a0 <uartputc>
  inb(COM1+2);
  inb(COM1+0);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80105a7b:	0f be 03             	movsbl (%ebx),%eax
80105a7e:	84 c0                	test   %al,%al
80105a80:	75 ee                	jne    80105a70 <uartinit+0x80>
    uartputc(*p);
}
80105a82:	83 c4 1c             	add    $0x1c,%esp
80105a85:	5b                   	pop    %ebx
80105a86:	5e                   	pop    %esi
80105a87:	5f                   	pop    %edi
80105a88:	5d                   	pop    %ebp
...
80105a96:	c7 04 24 70 59 10 80 	movl   $0x80105970,(%esp)
80105a9d:	e8 0e ad ff ff       	call   801007b0 <consoleintr>
}
80105aa2:	c9                   	leave  
80105aa3:	c3                   	ret    
...
80105aa6:	6a 00                	push   $0x0
  jmp alltraps
80105aa8:	e9 60 fb ff ff       	jmp    8010560d <alltraps>
...
80105aaf:	6a 01                	push   $0x1
  jmp alltraps
80105ab1:	e9 57 fb ff ff       	jmp    8010560d <alltraps>
...
80105ab6:	6a 00                	push   $0x0
  pushl $2
80105ab8:	6a 02                	push   $0x2
  jmp alltraps
80105aba:	e9 4e fb ff ff       	jmp    8010560d <alltraps>
...
80105abf:	6a 00                	push   $0x0
  pushl $3
80105ac1:	6a 03                	push   $0x3
  jmp alltraps
80105ac3:	e9 45 fb ff ff       	jmp    8010560d <alltraps>
...
80105aca:	6a 04                	push   $0x4
  jmp alltraps
80105acc:	e9 3c fb ff ff       	jmp    8010560d <alltraps>
...
80105ad1:	6a 00                	push   $0x0
  pushl $5
80105ad3:	6a 05                	push   $0x5
  jmp alltraps
80105ad5:	e9 33 fb ff ff       	jmp    8010560d <alltraps>
...
80105ada:	6a 00                	push   $0x0
  pushl $6
80105adc:	6a 06                	push   $0x6
  jmp alltraps
80105ade:	e9 2a fb ff ff       	jmp    8010560d <alltraps>
...
80105ae3:	6a 00                	push   $0x0
  pushl $7
80105ae5:	6a 07                	push   $0x7
  jmp alltraps
80105ae7:	e9 21 fb ff ff       	jmp    8010560d <alltraps>
...
80105aec:	6a 08                	push   $0x8
  jmp alltraps
80105aee:	e9 1a fb ff ff       	jmp    8010560d <alltraps>
...
80105af3:	6a 00                	push   $0x0
  pushl $9
80105af5:	6a 09                	push   $0x9
  jmp alltraps
80105af7:	e9 11 fb ff ff       	jmp    8010560d <alltraps>

80105afc <vector10>:
.globl vector10
vector10:
  pushl $10
80105afc:	6a 0a                	push   $0xa
  jmp alltraps
80105afe:	e9 0a fb ff ff       	jmp    8010560d <alltraps>

80105b03 <vector11>:
.globl vector11
vector11:
  pushl $11
80105b03:	6a 0b                	push   $0xb
  jmp alltraps
80105b05:	e9 03 fb ff ff       	jmp    8010560d <alltraps>

80105b0a <vector12>:
.globl vector12
vector12:
  pushl $12
80105b0a:	6a 0c                	push   $0xc
  jmp alltraps
80105b0c:	e9 fc fa ff ff       	jmp    8010560d <alltraps>

80105b11 <vector13>:
.globl vector13
vector13:
  pushl $13
80105b11:	6a 0d                	push   $0xd
  jmp alltraps
80105b13:	e9 f5 fa ff ff       	jmp    8010560d <alltraps>

80105b18 <vector14>:
.globl vector14
vector14:
  pushl $14
80105b18:	6a 0e                	push   $0xe
  jmp alltraps
80105b1a:	e9 ee fa ff ff       	jmp    8010560d <alltraps>
...
80105b1f:	6a 00                	push   $0x0
  pushl $15
80105b21:	6a 0f                	push   $0xf
  jmp alltraps
80105b23:	e9 e5 fa ff ff       	jmp    8010560d <alltraps>
...
80105b2a:	6a 10                	push   $0x10
  jmp alltraps
80105b2c:	e9 dc fa ff ff       	jmp    8010560d <alltraps>

80105b31 <vector17>:
.globl vector17
vector17:
  pushl $17
80105b31:	6a 11                	push   $0x11
  jmp alltraps
80105b33:	e9 d5 fa ff ff       	jmp    8010560d <alltraps>
...
80105b38:	6a 00                	push   $0x0
  pushl $18
80105b3a:	6a 12                	push   $0x12
  jmp alltraps
80105b3c:	e9 cc fa ff ff       	jmp    8010560d <alltraps>
...
80105b41:	6a 00                	push   $0x0
  pushl $19
80105b43:	6a 13                	push   $0x13
  jmp alltraps
80105b45:	e9 c3 fa ff ff       	jmp    8010560d <alltraps>
...
80105b4a:	6a 00                	push   $0x0
  pushl $20
80105b4c:	6a 14                	push   $0x14
  jmp alltraps
80105b4e:	e9 ba fa ff ff       	jmp    8010560d <alltraps>
...
80105b53:	6a 00                	push   $0x0
  pushl $21
80105b55:	6a 15                	push   $0x15
  jmp alltraps
80105b57:	e9 b1 fa ff ff       	jmp    8010560d <alltraps>
...
80105b5c:	6a 00                	push   $0x0
  pushl $22
80105b5e:	6a 16                	push   $0x16
  jmp alltraps
80105b60:	e9 a8 fa ff ff       	jmp    8010560d <alltraps>
...
80105b65:	6a 00                	push   $0x0
  pushl $23
80105b67:	6a 17                	push   $0x17
  jmp alltraps
80105b69:	e9 9f fa ff ff       	jmp    8010560d <alltraps>
...
80105b6e:	6a 00                	push   $0x0
  pushl $24
80105b70:	6a 18                	push   $0x18
  jmp alltraps
80105b72:	e9 96 fa ff ff       	jmp    8010560d <alltraps>
...
80105b77:	6a 00                	push   $0x0
  pushl $25
80105b79:	6a 19                	push   $0x19
  jmp alltraps
80105b7b:	e9 8d fa ff ff       	jmp    8010560d <alltraps>
...
80105b80:	6a 00                	push   $0x0
  pushl $26
80105b82:	6a 1a                	push   $0x1a
  jmp alltraps
80105b84:	e9 84 fa ff ff       	jmp    8010560d <alltraps>
...
80105b89:	6a 00                	push   $0x0
  pushl $27
80105b8b:	6a 1b                	push   $0x1b
  jmp alltraps
80105b8d:	e9 7b fa ff ff       	jmp    8010560d <alltraps>
...
80105b92:	6a 00                	push   $0x0
  pushl $28
80105b94:	6a 1c                	push   $0x1c
  jmp alltraps
80105b96:	e9 72 fa ff ff       	jmp    8010560d <alltraps>
...
80105b9b:	6a 00                	push   $0x0
  pushl $29
80105b9d:	6a 1d                	push   $0x1d
  jmp alltraps
80105b9f:	e9 69 fa ff ff       	jmp    8010560d <alltraps>
...
80105ba4:	6a 00                	push   $0x0
  pushl $30
80105ba6:	6a 1e                	push   $0x1e
  jmp alltraps
80105ba8:	e9 60 fa ff ff       	jmp    8010560d <alltraps>
...
80105bad:	6a 00                	push   $0x0
  pushl $31
80105baf:	6a 1f                	push   $0x1f
  jmp alltraps
80105bb1:	e9 57 fa ff ff       	jmp    8010560d <alltraps>
...
80105bb6:	6a 00                	push   $0x0
  pushl $32
80105bb8:	6a 20                	push   $0x20
  jmp alltraps
80105bba:	e9 4e fa ff ff       	jmp    8010560d <alltraps>
...
80105bbf:	6a 00                	push   $0x0
  pushl $33
80105bc1:	6a 21                	push   $0x21
  jmp alltraps
80105bc3:	e9 45 fa ff ff       	jmp    8010560d <alltraps>
...
80105bc8:	6a 00                	push   $0x0
  pushl $34
80105bca:	6a 22                	push   $0x22
  jmp alltraps
80105bcc:	e9 3c fa ff ff       	jmp    8010560d <alltraps>
...
80105bd1:	6a 00                	push   $0x0
  pushl $35
80105bd3:	6a 23                	push   $0x23
  jmp alltraps
80105bd5:	e9 33 fa ff ff       	jmp    8010560d <alltraps>
...
80105bda:	6a 00                	push   $0x0
  pushl $36
80105bdc:	6a 24                	push   $0x24
  jmp alltraps
80105bde:	e9 2a fa ff ff       	jmp    8010560d <alltraps>
...
80105be3:	6a 00                	push   $0x0
  pushl $37
80105be5:	6a 25                	push   $0x25
  jmp alltraps
80105be7:	e9 21 fa ff ff       	jmp    8010560d <alltraps>
...
80105bec:	6a 00                	push   $0x0
  pushl $38
80105bee:	6a 26                	push   $0x26
  jmp alltraps
80105bf0:	e9 18 fa ff ff       	jmp    8010560d <alltraps>
...
80105bf5:	6a 00                	push   $0x0
  pushl $39
80105bf7:	6a 27                	push   $0x27
  jmp alltraps
80105bf9:	e9 0f fa ff ff       	jmp    8010560d <alltraps>
...
80105bfe:	6a 00                	push   $0x0
  pushl $40
80105c00:	6a 28                	push   $0x28
  jmp alltraps
80105c02:	e9 06 fa ff ff       	jmp    8010560d <alltraps>
...
80105c07:	6a 00                	push   $0x0
  pushl $41
80105c09:	6a 29                	push   $0x29
  jmp alltraps
80105c0b:	e9 fd f9 ff ff       	jmp    8010560d <alltraps>
...
80105c10:	6a 00                	push   $0x0
  pushl $42
80105c12:	6a 2a                	push   $0x2a
  jmp alltraps
80105c14:	e9 f4 f9 ff ff       	jmp    8010560d <alltraps>
...
80105c19:	6a 00                	push   $0x0
  pushl $43
80105c1b:	6a 2b                	push   $0x2b
  jmp alltraps
80105c1d:	e9 eb f9 ff ff       	jmp    8010560d <alltraps>
...
80105c22:	6a 00                	push   $0x0
  pushl $44
80105c24:	6a 2c                	push   $0x2c
  jmp alltraps
80105c26:	e9 e2 f9 ff ff       	jmp    8010560d <alltraps>
...
80105c2b:	6a 00                	push   $0x0
  pushl $45
80105c2d:	6a 2d                	push   $0x2d
  jmp alltraps
80105c2f:	e9 d9 f9 ff ff       	jmp    8010560d <alltraps>
...
80105c34:	6a 00                	push   $0x0
  pushl $46
80105c36:	6a 2e                	push   $0x2e
  jmp alltraps
80105c38:	e9 d0 f9 ff ff       	jmp    8010560d <alltraps>
...
80105c3d:	6a 00                	push   $0x0
  pushl $47
80105c3f:	6a 2f                	push   $0x2f
  jmp alltraps
80105c41:	e9 c7 f9 ff ff       	jmp    8010560d <alltraps>
...
80105c46:	6a 00                	push   $0x0
  pushl $48
80105c48:	6a 30                	push   $0x30
  jmp alltraps
80105c4a:	e9 be f9 ff ff       	jmp    8010560d <alltraps>
...
80105c4f:	6a 00                	push   $0x0
  pushl $49
80105c51:	6a 31                	push   $0x31
  jmp alltraps
80105c53:	e9 b5 f9 ff ff       	jmp    8010560d <alltraps>
...
80105c58:	6a 00                	push   $0x0
  pushl $50
80105c5a:	6a 32                	push   $0x32
  jmp alltraps
80105c5c:	e9 ac f9 ff ff       	jmp    8010560d <alltraps>
...
80105c61:	6a 00                	push   $0x0
  pushl $51
80105c63:	6a 33                	push   $0x33
  jmp alltraps
80105c65:	e9 a3 f9 ff ff       	jmp    8010560d <alltraps>
...
80105c6a:	6a 00                	push   $0x0
  pushl $52
80105c6c:	6a 34                	push   $0x34
  jmp alltraps
80105c6e:	e9 9a f9 ff ff       	jmp    8010560d <alltraps>
...
80105c73:	6a 00                	push   $0x0
  pushl $53
80105c75:	6a 35                	push   $0x35
  jmp alltraps
80105c77:	e9 91 f9 ff ff       	jmp    8010560d <alltraps>
...
80105c7c:	6a 00                	push   $0x0
  pushl $54
80105c7e:	6a 36                	push   $0x36
  jmp alltraps
80105c80:	e9 88 f9 ff ff       	jmp    8010560d <alltraps>
...
80105c85:	6a 00                	push   $0x0
  pushl $55
80105c87:	6a 37                	push   $0x37
  jmp alltraps
80105c89:	e9 7f f9 ff ff       	jmp    8010560d <alltraps>
...
80105c8e:	6a 00                	push   $0x0
  pushl $56
80105c90:	6a 38                	push   $0x38
  jmp alltraps
80105c92:	e9 76 f9 ff ff       	jmp    8010560d <alltraps>
...
80105c97:	6a 00                	push   $0x0
  pushl $57
80105c99:	6a 39                	push   $0x39
  jmp alltraps
80105c9b:	e9 6d f9 ff ff       	jmp    8010560d <alltraps>
...
80105ca0:	6a 00                	push   $0x0
  pushl $58
80105ca2:	6a 3a                	push   $0x3a
  jmp alltraps
80105ca4:	e9 64 f9 ff ff       	jmp    8010560d <alltraps>
...
80105ca9:	6a 00                	push   $0x0
  pushl $59
80105cab:	6a 3b                	push   $0x3b
  jmp alltraps
80105cad:	e9 5b f9 ff ff       	jmp    8010560d <alltraps>
...
80105cb2:	6a 00                	push   $0x0
  pushl $60
80105cb4:	6a 3c                	push   $0x3c
  jmp alltraps
80105cb6:	e9 52 f9 ff ff       	jmp    8010560d <alltraps>
...
80105cbb:	6a 00                	push   $0x0
  pushl $61
80105cbd:	6a 3d                	push   $0x3d
  jmp alltraps
80105cbf:	e9 49 f9 ff ff       	jmp    8010560d <alltraps>
...
80105cc4:	6a 00                	push   $0x0
  pushl $62
80105cc6:	6a 3e                	push   $0x3e
  jmp alltraps
80105cc8:	e9 40 f9 ff ff       	jmp    8010560d <alltraps>
...
80105ccd:	6a 00                	push   $0x0
  pushl $63
80105ccf:	6a 3f                	push   $0x3f
  jmp alltraps
80105cd1:	e9 37 f9 ff ff       	jmp    8010560d <alltraps>
...
80105cd6:	6a 00                	push   $0x0
  pushl $64
80105cd8:	6a 40                	push   $0x40
  jmp alltraps
80105cda:	e9 2e f9 ff ff       	jmp    8010560d <alltraps>
...
80105cdf:	6a 00                	push   $0x0
  pushl $65
80105ce1:	6a 41                	push   $0x41
  jmp alltraps
80105ce3:	e9 25 f9 ff ff       	jmp    8010560d <alltraps>
...
80105ce8:	6a 00                	push   $0x0
  pushl $66
80105cea:	6a 42                	push   $0x42
  jmp alltraps
80105cec:	e9 1c f9 ff ff       	jmp    8010560d <alltraps>
...
80105cf1:	6a 00                	push   $0x0
  pushl $67
80105cf3:	6a 43                	push   $0x43
  jmp alltraps
80105cf5:	e9 13 f9 ff ff       	jmp    8010560d <alltraps>
...
80105cfa:	6a 00                	push   $0x0
  pushl $68
80105cfc:	6a 44                	push   $0x44
  jmp alltraps
80105cfe:	e9 0a f9 ff ff       	jmp    8010560d <alltraps>
...
80105d03:	6a 00                	push   $0x0
  pushl $69
80105d05:	6a 45                	push   $0x45
  jmp alltraps
80105d07:	e9 01 f9 ff ff       	jmp    8010560d <alltraps>
...
80105d0c:	6a 00                	push   $0x0
  pushl $70
80105d0e:	6a 46                	push   $0x46
  jmp alltraps
80105d10:	e9 f8 f8 ff ff       	jmp    8010560d <alltraps>
...
80105d15:	6a 00                	push   $0x0
  pushl $71
80105d17:	6a 47                	push   $0x47
  jmp alltraps
80105d19:	e9 ef f8 ff ff       	jmp    8010560d <alltraps>
...
80105d1e:	6a 00                	push   $0x0
  pushl $72
80105d20:	6a 48                	push   $0x48
  jmp alltraps
80105d22:	e9 e6 f8 ff ff       	jmp    8010560d <alltraps>
...
80105d27:	6a 00                	push   $0x0
  pushl $73
80105d29:	6a 49                	push   $0x49
  jmp alltraps
80105d2b:	e9 dd f8 ff ff       	jmp    8010560d <alltraps>
...
80105d30:	6a 00                	push   $0x0
  pushl $74
80105d32:	6a 4a                	push   $0x4a
  jmp alltraps
80105d34:	e9 d4 f8 ff ff       	jmp    8010560d <alltraps>
...
80105d39:	6a 00                	push   $0x0
  pushl $75
80105d3b:	6a 4b                	push   $0x4b
  jmp alltraps
80105d3d:	e9 cb f8 ff ff       	jmp    8010560d <alltraps>
...
80105d42:	6a 00                	push   $0x0
  pushl $76
80105d44:	6a 4c                	push   $0x4c
  jmp alltraps
80105d46:	e9 c2 f8 ff ff       	jmp    8010560d <alltraps>
...
80105d4b:	6a 00                	push   $0x0
  pushl $77
80105d4d:	6a 4d                	push   $0x4d
  jmp alltraps
80105d4f:	e9 b9 f8 ff ff       	jmp    8010560d <alltraps>
...
80105d54:	6a 00                	push   $0x0
  pushl $78
80105d56:	6a 4e                	push   $0x4e
  jmp alltraps
80105d58:	e9 b0 f8 ff ff       	jmp    8010560d <alltraps>
...
80105d5d:	6a 00                	push   $0x0
  pushl $79
80105d5f:	6a 4f                	push   $0x4f
  jmp alltraps
80105d61:	e9 a7 f8 ff ff       	jmp    8010560d <alltraps>
...
80105d66:	6a 00                	push   $0x0
  pushl $80
80105d68:	6a 50                	push   $0x50
  jmp alltraps
80105d6a:	e9 9e f8 ff ff       	jmp    8010560d <alltraps>
...
80105d6f:	6a 00                	push   $0x0
  pushl $81
80105d71:	6a 51                	push   $0x51
  jmp alltraps
80105d73:	e9 95 f8 ff ff       	jmp    8010560d <alltraps>
...
80105d78:	6a 00                	push   $0x0
  pushl $82
80105d7a:	6a 52                	push   $0x52
  jmp alltraps
80105d7c:	e9 8c f8 ff ff       	jmp    8010560d <alltraps>
...
80105d81:	6a 00                	push   $0x0
  pushl $83
80105d83:	6a 53                	push   $0x53
  jmp alltraps
80105d85:	e9 83 f8 ff ff       	jmp    8010560d <alltraps>
...
80105d8a:	6a 00                	push   $0x0
  pushl $84
80105d8c:	6a 54                	push   $0x54
  jmp alltraps
80105d8e:	e9 7a f8 ff ff       	jmp    8010560d <alltraps>
...
80105d93:	6a 00                	push   $0x0
  pushl $85
80105d95:	6a 55                	push   $0x55
  jmp alltraps
80105d97:	e9 71 f8 ff ff       	jmp    8010560d <alltraps>
...
80105d9c:	6a 00                	push   $0x0
  pushl $86
80105d9e:	6a 56                	push   $0x56
  jmp alltraps
80105da0:	e9 68 f8 ff ff       	jmp    8010560d <alltraps>
...
80105da5:	6a 00                	push   $0x0
  pushl $87
80105da7:	6a 57                	push   $0x57
  jmp alltraps
80105da9:	e9 5f f8 ff ff       	jmp    8010560d <alltraps>
...
80105dae:	6a 00                	push   $0x0
  pushl $88
80105db0:	6a 58                	push   $0x58
  jmp alltraps
80105db2:	e9 56 f8 ff ff       	jmp    8010560d <alltraps>
...
80105db7:	6a 00                	push   $0x0
  pushl $89
80105db9:	6a 59                	push   $0x59
  jmp alltraps
80105dbb:	e9 4d f8 ff ff       	jmp    8010560d <alltraps>
...
80105dc0:	6a 00                	push   $0x0
  pushl $90
80105dc2:	6a 5a                	push   $0x5a
  jmp alltraps
80105dc4:	e9 44 f8 ff ff       	jmp    8010560d <alltraps>
...
80105dc9:	6a 00                	push   $0x0
  pushl $91
80105dcb:	6a 5b                	push   $0x5b
  jmp alltraps
80105dcd:	e9 3b f8 ff ff       	jmp    8010560d <alltraps>
...
80105dd2:	6a 00                	push   $0x0
  pushl $92
80105dd4:	6a 5c                	push   $0x5c
  jmp alltraps
80105dd6:	e9 32 f8 ff ff       	jmp    8010560d <alltraps>
...
80105ddb:	6a 00                	push   $0x0
  pushl $93
80105ddd:	6a 5d                	push   $0x5d
  jmp alltraps
80105ddf:	e9 29 f8 ff ff       	jmp    8010560d <alltraps>
...
80105de4:	6a 00                	push   $0x0
  pushl $94
80105de6:	6a 5e                	push   $0x5e
  jmp alltraps
80105de8:	e9 20 f8 ff ff       	jmp    8010560d <alltraps>
...
80105ded:	6a 00                	push   $0x0
  pushl $95
80105def:	6a 5f                	push   $0x5f
  jmp alltraps
80105df1:	e9 17 f8 ff ff       	jmp    8010560d <alltraps>
...
80105df6:	6a 00                	push   $0x0
  pushl $96
80105df8:	6a 60                	push   $0x60
  jmp alltraps
80105dfa:	e9 0e f8 ff ff       	jmp    8010560d <alltraps>
...
80105dff:	6a 00                	push   $0x0
  pushl $97
80105e01:	6a 61                	push   $0x61
  jmp alltraps
80105e03:	e9 05 f8 ff ff       	jmp    8010560d <alltraps>
...
80105e08:	6a 00                	push   $0x0
  pushl $98
80105e0a:	6a 62                	push   $0x62
  jmp alltraps
80105e0c:	e9 fc f7 ff ff       	jmp    8010560d <alltraps>
...
80105e11:	6a 00                	push   $0x0
  pushl $99
80105e13:	6a 63                	push   $0x63
  jmp alltraps
80105e15:	e9 f3 f7 ff ff       	jmp    8010560d <alltraps>
...
80105e1a:	6a 00                	push   $0x0
  pushl $100
80105e1c:	6a 64                	push   $0x64
  jmp alltraps
80105e1e:	e9 ea f7 ff ff       	jmp    8010560d <alltraps>
...
80105e23:	6a 00                	push   $0x0
  pushl $101
80105e25:	6a 65                	push   $0x65
  jmp alltraps
80105e27:	e9 e1 f7 ff ff       	jmp    8010560d <alltraps>
...
80105e2c:	6a 00                	push   $0x0
  pushl $102
80105e2e:	6a 66                	push   $0x66
  jmp alltraps
80105e30:	e9 d8 f7 ff ff       	jmp    8010560d <alltraps>
...
80105e35:	6a 00                	push   $0x0
  pushl $103
80105e37:	6a 67                	push   $0x67
  jmp alltraps
80105e39:	e9 cf f7 ff ff       	jmp    8010560d <alltraps>
...
80105e3e:	6a 00                	push   $0x0
  pushl $104
80105e40:	6a 68                	push   $0x68
  jmp alltraps
80105e42:	e9 c6 f7 ff ff       	jmp    8010560d <alltraps>
...
80105e47:	6a 00                	push   $0x0
  pushl $105
80105e49:	6a 69                	push   $0x69
  jmp alltraps
80105e4b:	e9 bd f7 ff ff       	jmp    8010560d <alltraps>
...
80105e50:	6a 00                	push   $0x0
  pushl $106
80105e52:	6a 6a                	push   $0x6a
  jmp alltraps
80105e54:	e9 b4 f7 ff ff       	jmp    8010560d <alltraps>
...
80105e59:	6a 00                	push   $0x0
  pushl $107
80105e5b:	6a 6b                	push   $0x6b
  jmp alltraps
80105e5d:	e9 ab f7 ff ff       	jmp    8010560d <alltraps>
...
80105e62:	6a 00                	push   $0x0
  pushl $108
80105e64:	6a 6c                	push   $0x6c
  jmp alltraps
80105e66:	e9 a2 f7 ff ff       	jmp    8010560d <alltraps>
...
80105e6b:	6a 00                	push   $0x0
  pushl $109
80105e6d:	6a 6d                	push   $0x6d
  jmp alltraps
80105e6f:	e9 99 f7 ff ff       	jmp    8010560d <alltraps>
...
80105e74:	6a 00                	push   $0x0
  pushl $110
80105e76:	6a 6e                	push   $0x6e
  jmp alltraps
80105e78:	e9 90 f7 ff ff       	jmp    8010560d <alltraps>
...
80105e7d:	6a 00                	push   $0x0
  pushl $111
80105e7f:	6a 6f                	push   $0x6f
  jmp alltraps
80105e81:	e9 87 f7 ff ff       	jmp    8010560d <alltraps>
...
80105e86:	6a 00                	push   $0x0
  pushl $112
80105e88:	6a 70                	push   $0x70
  jmp alltraps
80105e8a:	e9 7e f7 ff ff       	jmp    8010560d <alltraps>
...
80105e8f:	6a 00                	push   $0x0
  pushl $113
80105e91:	6a 71                	push   $0x71
  jmp alltraps
80105e93:	e9 75 f7 ff ff       	jmp    8010560d <alltraps>
...
80105e98:	6a 00                	push   $0x0
  pushl $114
80105e9a:	6a 72                	push   $0x72
  jmp alltraps
80105e9c:	e9 6c f7 ff ff       	jmp    8010560d <alltraps>
...
80105ea1:	6a 00                	push   $0x0
  pushl $115
80105ea3:	6a 73                	push   $0x73
  jmp alltraps
80105ea5:	e9 63 f7 ff ff       	jmp    8010560d <alltraps>
...
80105eaa:	6a 00                	push   $0x0
  pushl $116
80105eac:	6a 74                	push   $0x74
  jmp alltraps
80105eae:	e9 5a f7 ff ff       	jmp    8010560d <alltraps>
...
80105eb3:	6a 00                	push   $0x0
  pushl $117
80105eb5:	6a 75                	push   $0x75
  jmp alltraps
80105eb7:	e9 51 f7 ff ff       	jmp    8010560d <alltraps>
...
80105ebc:	6a 00                	push   $0x0
  pushl $118
80105ebe:	6a 76                	push   $0x76
  jmp alltraps
80105ec0:	e9 48 f7 ff ff       	jmp    8010560d <alltraps>
...
80105ec5:	6a 00                	push   $0x0
  pushl $119
80105ec7:	6a 77                	push   $0x77
  jmp alltraps
80105ec9:	e9 3f f7 ff ff       	jmp    8010560d <alltraps>
...
80105ece:	6a 00                	push   $0x0
  pushl $120
80105ed0:	6a 78                	push   $0x78
  jmp alltraps
80105ed2:	e9 36 f7 ff ff       	jmp    8010560d <alltraps>
...
80105ed7:	6a 00                	push   $0x0
  pushl $121
80105ed9:	6a 79                	push   $0x79
  jmp alltraps
80105edb:	e9 2d f7 ff ff       	jmp    8010560d <alltraps>
...
80105ee0:	6a 00                	push   $0x0
  pushl $122
80105ee2:	6a 7a                	push   $0x7a
  jmp alltraps
80105ee4:	e9 24 f7 ff ff       	jmp    8010560d <alltraps>
...
80105ee9:	6a 00                	push   $0x0
  pushl $123
80105eeb:	6a 7b                	push   $0x7b
  jmp alltraps
80105eed:	e9 1b f7 ff ff       	jmp    8010560d <alltraps>
...
80105ef2:	6a 00                	push   $0x0
  pushl $124
80105ef4:	6a 7c                	push   $0x7c
  jmp alltraps
80105ef6:	e9 12 f7 ff ff       	jmp    8010560d <alltraps>
...
80105efb:	6a 00                	push   $0x0
  pushl $125
80105efd:	6a 7d                	push   $0x7d
  jmp alltraps
80105eff:	e9 09 f7 ff ff       	jmp    8010560d <alltraps>
...
80105f04:	6a 00                	push   $0x0
  pushl $126
80105f06:	6a 7e                	push   $0x7e
  jmp alltraps
80105f08:	e9 00 f7 ff ff       	jmp    8010560d <alltraps>
...
80105f0d:	6a 00                	push   $0x0
  pushl $127
80105f0f:	6a 7f                	push   $0x7f
  jmp alltraps
80105f11:	e9 f7 f6 ff ff       	jmp    8010560d <alltraps>
...
80105f18:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105f1d:	e9 eb f6 ff ff       	jmp    8010560d <alltraps>
...
80105f22:	6a 00                	push   $0x0
  pushl $129
80105f24:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105f29:	e9 df f6 ff ff       	jmp    8010560d <alltraps>
...
80105f2e:	6a 00                	push   $0x0
  pushl $130
80105f30:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105f35:	e9 d3 f6 ff ff       	jmp    8010560d <alltraps>
...
80105f3a:	6a 00                	push   $0x0
  pushl $131
80105f3c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105f41:	e9 c7 f6 ff ff       	jmp    8010560d <alltraps>
...
80105f46:	6a 00                	push   $0x0
  pushl $132
80105f48:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105f4d:	e9 bb f6 ff ff       	jmp    8010560d <alltraps>
...
80105f52:	6a 00                	push   $0x0
  pushl $133
80105f54:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105f59:	e9 af f6 ff ff       	jmp    8010560d <alltraps>
...
80105f5e:	6a 00                	push   $0x0
  pushl $134
80105f60:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105f65:	e9 a3 f6 ff ff       	jmp    8010560d <alltraps>
...
80105f6a:	6a 00                	push   $0x0
  pushl $135
80105f6c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105f71:	e9 97 f6 ff ff       	jmp    8010560d <alltraps>
...
80105f76:	6a 00                	push   $0x0
  pushl $136
80105f78:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105f7d:	e9 8b f6 ff ff       	jmp    8010560d <alltraps>
...
80105f82:	6a 00                	push   $0x0
  pushl $137
80105f84:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105f89:	e9 7f f6 ff ff       	jmp    8010560d <alltraps>
...
80105f8e:	6a 00                	push   $0x0
  pushl $138
80105f90:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105f95:	e9 73 f6 ff ff       	jmp    8010560d <alltraps>
...
80105f9a:	6a 00                	push   $0x0
  pushl $139
80105f9c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105fa1:	e9 67 f6 ff ff       	jmp    8010560d <alltraps>
...
80105fa6:	6a 00                	push   $0x0
  pushl $140
80105fa8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105fad:	e9 5b f6 ff ff       	jmp    8010560d <alltraps>
...
80105fb2:	6a 00                	push   $0x0
  pushl $141
80105fb4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105fb9:	e9 4f f6 ff ff       	jmp    8010560d <alltraps>
...
80105fbe:	6a 00                	push   $0x0
  pushl $142
80105fc0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105fc5:	e9 43 f6 ff ff       	jmp    8010560d <alltraps>
...
80105fca:	6a 00                	push   $0x0
  pushl $143
80105fcc:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105fd1:	e9 37 f6 ff ff       	jmp    8010560d <alltraps>
...
80105fd6:	6a 00                	push   $0x0
  pushl $144
80105fd8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105fdd:	e9 2b f6 ff ff       	jmp    8010560d <alltraps>
...
80105fe2:	6a 00                	push   $0x0
  pushl $145
80105fe4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105fe9:	e9 1f f6 ff ff       	jmp    8010560d <alltraps>
...
80105fee:	6a 00                	push   $0x0
  pushl $146
80105ff0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105ff5:	e9 13 f6 ff ff       	jmp    8010560d <alltraps>
...
80105ffa:	6a 00                	push   $0x0
  pushl $147
80105ffc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106001:	e9 07 f6 ff ff       	jmp    8010560d <alltraps>
...
80106006:	6a 00                	push   $0x0
  pushl $148
80106008:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010600d:	e9 fb f5 ff ff       	jmp    8010560d <alltraps>
...
80106012:	6a 00                	push   $0x0
  pushl $149
80106014:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106019:	e9 ef f5 ff ff       	jmp    8010560d <alltraps>
...
8010601e:	6a 00                	push   $0x0
  pushl $150
80106020:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106025:	e9 e3 f5 ff ff       	jmp    8010560d <alltraps>
...
8010602a:	6a 00                	push   $0x0
  pushl $151
8010602c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106031:	e9 d7 f5 ff ff       	jmp    8010560d <alltraps>
...
80106036:	6a 00                	push   $0x0
  pushl $152
80106038:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010603d:	e9 cb f5 ff ff       	jmp    8010560d <alltraps>
...
80106042:	6a 00                	push   $0x0
  pushl $153
80106044:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106049:	e9 bf f5 ff ff       	jmp    8010560d <alltraps>
...
8010604e:	6a 00                	push   $0x0
  pushl $154
80106050:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106055:	e9 b3 f5 ff ff       	jmp    8010560d <alltraps>
...
8010605a:	6a 00                	push   $0x0
  pushl $155
8010605c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106061:	e9 a7 f5 ff ff       	jmp    8010560d <alltraps>
...
80106066:	6a 00                	push   $0x0
  pushl $156
80106068:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010606d:	e9 9b f5 ff ff       	jmp    8010560d <alltraps>
...
80106072:	6a 00                	push   $0x0
  pushl $157
80106074:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106079:	e9 8f f5 ff ff       	jmp    8010560d <alltraps>
...
8010607e:	6a 00                	push   $0x0
  pushl $158
80106080:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106085:	e9 83 f5 ff ff       	jmp    8010560d <alltraps>
...
8010608a:	6a 00                	push   $0x0
  pushl $159
8010608c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106091:	e9 77 f5 ff ff       	jmp    8010560d <alltraps>
...
80106096:	6a 00                	push   $0x0
  pushl $160
80106098:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010609d:	e9 6b f5 ff ff       	jmp    8010560d <alltraps>
...
801060a2:	6a 00                	push   $0x0
  pushl $161
801060a4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801060a9:	e9 5f f5 ff ff       	jmp    8010560d <alltraps>
...
801060ae:	6a 00                	push   $0x0
  pushl $162
801060b0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801060b5:	e9 53 f5 ff ff       	jmp    8010560d <alltraps>
...
801060ba:	6a 00                	push   $0x0
  pushl $163
801060bc:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801060c1:	e9 47 f5 ff ff       	jmp    8010560d <alltraps>
...
801060c6:	6a 00                	push   $0x0
  pushl $164
801060c8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801060cd:	e9 3b f5 ff ff       	jmp    8010560d <alltraps>
...
801060d2:	6a 00                	push   $0x0
  pushl $165
801060d4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801060d9:	e9 2f f5 ff ff       	jmp    8010560d <alltraps>
...
801060de:	6a 00                	push   $0x0
  pushl $166
801060e0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801060e5:	e9 23 f5 ff ff       	jmp    8010560d <alltraps>
...
801060ea:	6a 00                	push   $0x0
  pushl $167
801060ec:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801060f1:	e9 17 f5 ff ff       	jmp    8010560d <alltraps>
...
801060f6:	6a 00                	push   $0x0
  pushl $168
801060f8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801060fd:	e9 0b f5 ff ff       	jmp    8010560d <alltraps>
...
80106102:	6a 00                	push   $0x0
  pushl $169
80106104:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106109:	e9 ff f4 ff ff       	jmp    8010560d <alltraps>
...
8010610e:	6a 00                	push   $0x0
  pushl $170
80106110:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106115:	e9 f3 f4 ff ff       	jmp    8010560d <alltraps>
...
8010611a:	6a 00                	push   $0x0
  pushl $171
8010611c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106121:	e9 e7 f4 ff ff       	jmp    8010560d <alltraps>
...
80106126:	6a 00                	push   $0x0
  pushl $172
80106128:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010612d:	e9 db f4 ff ff       	jmp    8010560d <alltraps>
...
80106132:	6a 00                	push   $0x0
  pushl $173
80106134:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106139:	e9 cf f4 ff ff       	jmp    8010560d <alltraps>
...
8010613e:	6a 00                	push   $0x0
  pushl $174
80106140:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106145:	e9 c3 f4 ff ff       	jmp    8010560d <alltraps>
...
8010614a:	6a 00                	push   $0x0
  pushl $175
8010614c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106151:	e9 b7 f4 ff ff       	jmp    8010560d <alltraps>
...
80106156:	6a 00                	push   $0x0
  pushl $176
80106158:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010615d:	e9 ab f4 ff ff       	jmp    8010560d <alltraps>
...
80106162:	6a 00                	push   $0x0
  pushl $177
80106164:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106169:	e9 9f f4 ff ff       	jmp    8010560d <alltraps>
...
8010616e:	6a 00                	push   $0x0
  pushl $178
80106170:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106175:	e9 93 f4 ff ff       	jmp    8010560d <alltraps>
...
8010617a:	6a 00                	push   $0x0
  pushl $179
8010617c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106181:	e9 87 f4 ff ff       	jmp    8010560d <alltraps>
...
80106186:	6a 00                	push   $0x0
  pushl $180
80106188:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010618d:	e9 7b f4 ff ff       	jmp    8010560d <alltraps>
...
80106192:	6a 00                	push   $0x0
  pushl $181
80106194:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106199:	e9 6f f4 ff ff       	jmp    8010560d <alltraps>
...
8010619e:	6a 00                	push   $0x0
  pushl $182
801061a0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801061a5:	e9 63 f4 ff ff       	jmp    8010560d <alltraps>
...
801061aa:	6a 00                	push   $0x0
  pushl $183
801061ac:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801061b1:	e9 57 f4 ff ff       	jmp    8010560d <alltraps>
...
801061b6:	6a 00                	push   $0x0
  pushl $184
801061b8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801061bd:	e9 4b f4 ff ff       	jmp    8010560d <alltraps>
...
801061c2:	6a 00                	push   $0x0
  pushl $185
801061c4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801061c9:	e9 3f f4 ff ff       	jmp    8010560d <alltraps>
...
801061ce:	6a 00                	push   $0x0
  pushl $186
801061d0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801061d5:	e9 33 f4 ff ff       	jmp    8010560d <alltraps>
...
801061da:	6a 00                	push   $0x0
  pushl $187
801061dc:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801061e1:	e9 27 f4 ff ff       	jmp    8010560d <alltraps>
...
801061e6:	6a 00                	push   $0x0
  pushl $188
801061e8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801061ed:	e9 1b f4 ff ff       	jmp    8010560d <alltraps>
...
801061f2:	6a 00                	push   $0x0
  pushl $189
801061f4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801061f9:	e9 0f f4 ff ff       	jmp    8010560d <alltraps>
...
801061fe:	6a 00                	push   $0x0
  pushl $190
80106200:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106205:	e9 03 f4 ff ff       	jmp    8010560d <alltraps>
...
8010620a:	6a 00                	push   $0x0
  pushl $191
8010620c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106211:	e9 f7 f3 ff ff       	jmp    8010560d <alltraps>
...
80106216:	6a 00                	push   $0x0
  pushl $192
80106218:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010621d:	e9 eb f3 ff ff       	jmp    8010560d <alltraps>
...
80106222:	6a 00                	push   $0x0
  pushl $193
80106224:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106229:	e9 df f3 ff ff       	jmp    8010560d <alltraps>
...
8010622e:	6a 00                	push   $0x0
  pushl $194
80106230:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106235:	e9 d3 f3 ff ff       	jmp    8010560d <alltraps>
...
8010623a:	6a 00                	push   $0x0
  pushl $195
8010623c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106241:	e9 c7 f3 ff ff       	jmp    8010560d <alltraps>
...
80106246:	6a 00                	push   $0x0
  pushl $196
80106248:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010624d:	e9 bb f3 ff ff       	jmp    8010560d <alltraps>
...
80106252:	6a 00                	push   $0x0
  pushl $197
80106254:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106259:	e9 af f3 ff ff       	jmp    8010560d <alltraps>
...
8010625e:	6a 00                	push   $0x0
  pushl $198
80106260:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106265:	e9 a3 f3 ff ff       	jmp    8010560d <alltraps>
...
8010626a:	6a 00                	push   $0x0
  pushl $199
8010626c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106271:	e9 97 f3 ff ff       	jmp    8010560d <alltraps>
...
80106276:	6a 00                	push   $0x0
  pushl $200
80106278:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010627d:	e9 8b f3 ff ff       	jmp    8010560d <alltraps>
...
80106282:	6a 00                	push   $0x0
  pushl $201
80106284:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106289:	e9 7f f3 ff ff       	jmp    8010560d <alltraps>
...
8010628e:	6a 00                	push   $0x0
  pushl $202
80106290:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106295:	e9 73 f3 ff ff       	jmp    8010560d <alltraps>
...
8010629a:	6a 00                	push   $0x0
  pushl $203
8010629c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801062a1:	e9 67 f3 ff ff       	jmp    8010560d <alltraps>
...
801062a6:	6a 00                	push   $0x0
  pushl $204
801062a8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801062ad:	e9 5b f3 ff ff       	jmp    8010560d <alltraps>
...
801062b2:	6a 00                	push   $0x0
  pushl $205
801062b4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801062b9:	e9 4f f3 ff ff       	jmp    8010560d <alltraps>
...
801062be:	6a 00                	push   $0x0
  pushl $206
801062c0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801062c5:	e9 43 f3 ff ff       	jmp    8010560d <alltraps>
...
801062ca:	6a 00                	push   $0x0
  pushl $207
801062cc:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801062d1:	e9 37 f3 ff ff       	jmp    8010560d <alltraps>
...
801062d6:	6a 00                	push   $0x0
  pushl $208
801062d8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801062dd:	e9 2b f3 ff ff       	jmp    8010560d <alltraps>
...
801062e2:	6a 00                	push   $0x0
  pushl $209
801062e4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801062e9:	e9 1f f3 ff ff       	jmp    8010560d <alltraps>
...
801062ee:	6a 00                	push   $0x0
  pushl $210
801062f0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801062f5:	e9 13 f3 ff ff       	jmp    8010560d <alltraps>
...
801062fa:	6a 00                	push   $0x0
  pushl $211
801062fc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106301:	e9 07 f3 ff ff       	jmp    8010560d <alltraps>
...
80106306:	6a 00                	push   $0x0
  pushl $212
80106308:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010630d:	e9 fb f2 ff ff       	jmp    8010560d <alltraps>
...
80106312:	6a 00                	push   $0x0
  pushl $213
80106314:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106319:	e9 ef f2 ff ff       	jmp    8010560d <alltraps>
...
8010631e:	6a 00                	push   $0x0
  pushl $214
80106320:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106325:	e9 e3 f2 ff ff       	jmp    8010560d <alltraps>
...
8010632a:	6a 00                	push   $0x0
  pushl $215
8010632c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106331:	e9 d7 f2 ff ff       	jmp    8010560d <alltraps>
...
80106336:	6a 00                	push   $0x0
  pushl $216
80106338:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010633d:	e9 cb f2 ff ff       	jmp    8010560d <alltraps>
...
80106342:	6a 00                	push   $0x0
  pushl $217
80106344:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106349:	e9 bf f2 ff ff       	jmp    8010560d <alltraps>
...
8010634e:	6a 00                	push   $0x0
  pushl $218
80106350:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106355:	e9 b3 f2 ff ff       	jmp    8010560d <alltraps>
...
8010635a:	6a 00                	push   $0x0
  pushl $219
8010635c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106361:	e9 a7 f2 ff ff       	jmp    8010560d <alltraps>
...
80106366:	6a 00                	push   $0x0
  pushl $220
80106368:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010636d:	e9 9b f2 ff ff       	jmp    8010560d <alltraps>
...
80106372:	6a 00                	push   $0x0
  pushl $221
80106374:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106379:	e9 8f f2 ff ff       	jmp    8010560d <alltraps>
...
8010637e:	6a 00                	push   $0x0
  pushl $222
80106380:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106385:	e9 83 f2 ff ff       	jmp    8010560d <alltraps>
...
8010638a:	6a 00                	push   $0x0
  pushl $223
8010638c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106391:	e9 77 f2 ff ff       	jmp    8010560d <alltraps>
...
80106396:	6a 00                	push   $0x0
  pushl $224
80106398:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010639d:	e9 6b f2 ff ff       	jmp    8010560d <alltraps>
...
801063a2:	6a 00                	push   $0x0
  pushl $225
801063a4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801063a9:	e9 5f f2 ff ff       	jmp    8010560d <alltraps>
...
801063ae:	6a 00                	push   $0x0
  pushl $226
801063b0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801063b5:	e9 53 f2 ff ff       	jmp    8010560d <alltraps>
...
801063ba:	6a 00                	push   $0x0
  pushl $227
801063bc:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801063c1:	e9 47 f2 ff ff       	jmp    8010560d <alltraps>
...
801063c6:	6a 00                	push   $0x0
  pushl $228
801063c8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801063cd:	e9 3b f2 ff ff       	jmp    8010560d <alltraps>
...
801063d2:	6a 00                	push   $0x0
  pushl $229
801063d4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801063d9:	e9 2f f2 ff ff       	jmp    8010560d <alltraps>
...
801063de:	6a 00                	push   $0x0
  pushl $230
801063e0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801063e5:	e9 23 f2 ff ff       	jmp    8010560d <alltraps>
...
801063ea:	6a 00                	push   $0x0
  pushl $231
801063ec:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801063f1:	e9 17 f2 ff ff       	jmp    8010560d <alltraps>
...
801063f6:	6a 00                	push   $0x0
  pushl $232
801063f8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801063fd:	e9 0b f2 ff ff       	jmp    8010560d <alltraps>
...
80106402:	6a 00                	push   $0x0
  pushl $233
80106404:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106409:	e9 ff f1 ff ff       	jmp    8010560d <alltraps>
...
8010640e:	6a 00                	push   $0x0
  pushl $234
80106410:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106415:	e9 f3 f1 ff ff       	jmp    8010560d <alltraps>
...
8010641a:	6a 00                	push   $0x0
  pushl $235
8010641c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106421:	e9 e7 f1 ff ff       	jmp    8010560d <alltraps>
...
80106426:	6a 00                	push   $0x0
  pushl $236
80106428:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010642d:	e9 db f1 ff ff       	jmp    8010560d <alltraps>
...
80106432:	6a 00                	push   $0x0
  pushl $237
80106434:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106439:	e9 cf f1 ff ff       	jmp    8010560d <alltraps>
...
8010643e:	6a 00                	push   $0x0
  pushl $238
80106440:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106445:	e9 c3 f1 ff ff       	jmp    8010560d <alltraps>
...
8010644a:	6a 00                	push   $0x0
  pushl $239
8010644c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106451:	e9 b7 f1 ff ff       	jmp    8010560d <alltraps>
...
80106456:	6a 00                	push   $0x0
  pushl $240
80106458:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010645d:	e9 ab f1 ff ff       	jmp    8010560d <alltraps>
...
80106462:	6a 00                	push   $0x0
  pushl $241
80106464:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106469:	e9 9f f1 ff ff       	jmp    8010560d <alltraps>
...
8010646e:	6a 00                	push   $0x0
  pushl $242
80106470:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106475:	e9 93 f1 ff ff       	jmp    8010560d <alltraps>
...
8010647a:	6a 00                	push   $0x0
  pushl $243
8010647c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106481:	e9 87 f1 ff ff       	jmp    8010560d <alltraps>
...
80106486:	6a 00                	push   $0x0
  pushl $244
80106488:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010648d:	e9 7b f1 ff ff       	jmp    8010560d <alltraps>
...
80106492:	6a 00                	push   $0x0
  pushl $245
80106494:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106499:	e9 6f f1 ff ff       	jmp    8010560d <alltraps>
...
8010649e:	6a 00                	push   $0x0
  pushl $246
801064a0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801064a5:	e9 63 f1 ff ff       	jmp    8010560d <alltraps>
...
801064aa:	6a 00                	push   $0x0
  pushl $247
801064ac:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801064b1:	e9 57 f1 ff ff       	jmp    8010560d <alltraps>
...
801064b6:	6a 00                	push   $0x0
  pushl $248
801064b8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801064bd:	e9 4b f1 ff ff       	jmp    8010560d <alltraps>
...
801064c2:	6a 00                	push   $0x0
  pushl $249
801064c4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801064c9:	e9 3f f1 ff ff       	jmp    8010560d <alltraps>
...
801064ce:	6a 00                	push   $0x0
  pushl $250
801064d0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801064d5:	e9 33 f1 ff ff       	jmp    8010560d <alltraps>
...
801064da:	6a 00                	push   $0x0
  pushl $251
801064dc:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801064e1:	e9 27 f1 ff ff       	jmp    8010560d <alltraps>
...
801064e6:	6a 00                	push   $0x0
  pushl $252
801064e8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801064ed:	e9 1b f1 ff ff       	jmp    8010560d <alltraps>
...
801064f2:	6a 00                	push   $0x0
  pushl $253
801064f4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801064f9:	e9 0f f1 ff ff       	jmp    8010560d <alltraps>
...
801064fe:	6a 00                	push   $0x0
  pushl $254
80106500:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106505:	e9 03 f1 ff ff       	jmp    8010560d <alltraps>
...
8010650a:	6a 00                	push   $0x0
  pushl $255
8010650c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106511:	e9 f7 f0 ff ff       	jmp    8010560d <alltraps>
...
80106525:	89 d6                	mov    %edx,%esi
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80106527:	c1 ea 16             	shr    $0x16,%edx
// Return the address of the PTE in page table pgdir
// that corresponds to virtual address va.  If alloc!=0,
// create any required page table pages.
static pte_t *
...
8010652a:	53                   	push   %ebx
  ...
  pde = &pgdir[PDX(va)];
8010652b:	8d 3c 90             	lea    (%eax,%edx,4),%edi
// Return the address of the PTE in page table pgdir
// that corresponds to virtual address va.  If alloc!=0,
// create any required page table pages.
static pte_t *
...
8010652e:	83 ec 1c             	sub    $0x1c,%esp
  ...
  pde = &pgdir[PDX(va)];
  if(*pde & PTE_P){
80106531:	8b 1f                	mov    (%edi),%ebx
80106533:	f6 c3 01             	test   $0x1,%bl
80106536:	74 28                	je     80106560 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106538:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
8010653e:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
80106544:	c1 ee 0a             	shr    $0xa,%esi
}
80106547:	83 c4 1c             	add    $0x1c,%esp
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010654c:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80106552:	8d 04 13             	lea    (%ebx,%edx,1),%eax
}
80106555:	5b                   	pop    %ebx
80106556:	5e                   	pop    %esi
80106557:	5f                   	pop    %edi
...
80106562:	74 34                	je     80106598 <walkpgdir+0x78>
80106564:	e8 47 bf ff ff       	call   801024b0 <kalloc>
80106569:	85 c0                	test   %eax,%eax
8010656b:	89 c3                	mov    %eax,%ebx
8010656d:	74 29                	je     80106598 <walkpgdir+0x78>
      return 0;
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
8010656f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106576:	00 
80106577:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010657e:	00 
8010657f:	89 04 24             	mov    %eax,(%esp)
80106582:	e8 19 df ff ff       	call   801044a0 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106592:	eb b0                	jmp    80106544 <walkpgdir+0x24>
...
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
801065b8:	83 ec 1c             	sub    $0x1c,%esp
801065bb:	8b 7d 08             	mov    0x8(%ebp),%edi
  char *a, *last;
  pte_t *pte;
...
801065c7:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
801065cb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
801065ce:	83 4d 0c 01          	orl    $0x1,0xc(%ebp)
{
  char *a, *last;
  pte_t *pte;
  ...
  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801065d2:	81 65 e4 00 f0 ff ff 	andl   $0xfffff000,-0x1c(%ebp)
801065d9:	29 df                	sub    %ebx,%edi
801065db:	eb 18                	jmp    801065f5 <mappages+0x45>
...
801065e3:	75 3d                	jne    80106622 <mappages+0x72>
      panic("remap");
    *pte = pa | perm | PTE_P;
801065e5:	0b 75 0c             	or     0xc(%ebp),%esi
    if(a == last)
...
80106602:	e8 19 ff ff ff       	call   80106520 <walkpgdir>
...
80106621:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
80106622:	c7 04 24 10 77 10 80 	movl   $0x80107710,(%esp)
...
80106639:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
8010663a:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
// Deallocate user pages to bring the process size from oldsz to
// newsz.  oldsz and newsz need not be page-aligned, nor does newsz
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
int
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106640:	83 ec 1c             	sub    $0x1c,%esp
  uint a, pa;
  ...
  a = PGROUNDUP(newsz);
80106643:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106649:	39 d3                	cmp    %edx,%ebx
// Deallocate user pages to bring the process size from oldsz to
// newsz.  oldsz and newsz need not be page-aligned, nor does newsz
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
int
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
8010664b:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
8010664e:	72 3b                	jb     8010668b <deallocuvm.part.0+0x5b>
80106650:	eb 5e                	jmp    801066b0 <deallocuvm.part.0+0x80>
...
8010665d:	74 22                	je     80106681 <deallocuvm.part.0+0x51>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
8010665f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106665:	74 54                	je     801066bb <deallocuvm.part.0+0x8b>
        panic("kfree");
      char *v = P2V(pa);
80106667:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
8010666d:	89 14 24             	mov    %edx,(%esp)
80106670:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106673:	e8 88 bc ff ff       	call   80102300 <kfree>
      *pte = 0;
80106678:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010667b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80106681:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106687:	39 f3                	cmp    %esi,%ebx
80106689:	73 25                	jae    801066b0 <deallocuvm.part.0+0x80>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010668b:	31 c9                	xor    %ecx,%ecx
8010668d:	89 da                	mov    %ebx,%edx
8010668f:	89 f8                	mov    %edi,%eax
80106691:	e8 8a fe ff ff       	call   80106520 <walkpgdir>
    if(!pte)
80106696:	85 c0                	test   %eax,%eax
80106698:	75 be                	jne    80106658 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010669a:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
801066a0:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
801066a6:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801066ac:	39 f3                	cmp    %esi,%ebx
801066ae:	72 db                	jb     8010668b <deallocuvm.part.0+0x5b>
      kfree(v);
      *pte = 0;
    }
  }
...
801066b0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801066b3:	83 c4 1c             	add    $0x1c,%esp
801066b6:	5b                   	pop    %ebx
801066b7:	5e                   	pop    %esi
801066b8:	5f                   	pop    %edi
801066b9:	5d                   	pop    %ebp
801066ba:	c3                   	ret    
    if(!pte)
      ...
      if(pa == 0)
        panic("kfree");
801066bb:	c7 04 24 a6 70 10 80 	movl   $0x801070a6,(%esp)
801066c2:	e8 99 9c ff ff       	call   80100360 <panic>
...
801066d3:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
801066d6:	e8 b5 cf ff ff       	call   80103690 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801066db:	31 c9                	xor    %ecx,%ecx
801066dd:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
801066e2:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
801066e8:	05 80 27 11 80       	add    $0x80112780,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801066ed:	66 89 50 78          	mov    %dx,0x78(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801066f1:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
  lgdt(c->gdt, sizeof(c->gdt));
801066f6:	83 c0 70             	add    $0x70,%eax
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801066f9:	66 89 48 0a          	mov    %cx,0xa(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801066fd:	31 c9                	xor    %ecx,%ecx
801066ff:	66 89 50 10          	mov    %dx,0x10(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106703:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106708:	66 89 48 12          	mov    %cx,0x12(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010670c:	31 c9                	xor    %ecx,%ecx
8010670e:	66 89 50 18          	mov    %dx,0x18(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106712:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106717:	66 89 48 1a          	mov    %cx,0x1a(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010671b:	31 c9                	xor    %ecx,%ecx
  ...
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010671d:	c6 40 0d 9a          	movb   $0x9a,0xd(%eax)
80106721:	c6 40 0e cf          	movb   $0xcf,0xe(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106725:	c6 40 15 92          	movb   $0x92,0x15(%eax)
80106729:	c6 40 16 cf          	movb   $0xcf,0x16(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010672d:	c6 40 1d fa          	movb   $0xfa,0x1d(%eax)
80106731:	c6 40 1e cf          	movb   $0xcf,0x1e(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106735:	c6 40 25 f2          	movb   $0xf2,0x25(%eax)
80106739:	c6 40 26 cf          	movb   $0xcf,0x26(%eax)
8010673d:	66 89 50 20          	mov    %dx,0x20(%eax)
static inline void
...
80106741:	ba 2f 00 00 00       	mov    $0x2f,%edx
  ...
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106746:	c6 40 0c 00          	movb   $0x0,0xc(%eax)
8010674a:	c6 40 0f 00          	movb   $0x0,0xf(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010674e:	c6 40 14 00          	movb   $0x0,0x14(%eax)
80106752:	c6 40 17 00          	movb   $0x0,0x17(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106756:	c6 40 1c 00          	movb   $0x0,0x1c(%eax)
8010675a:	c6 40 1f 00          	movb   $0x0,0x1f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010675e:	66 89 48 22          	mov    %cx,0x22(%eax)
80106762:	c6 40 24 00          	movb   $0x0,0x24(%eax)
80106766:	c6 40 27 00          	movb   $0x0,0x27(%eax)
8010676a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  pd[1] = (uint)p;
8010676e:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106772:	c1 e8 10             	shr    $0x10,%eax
80106775:	66 89 45 f6          	mov    %ax,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80106779:	8d 45 f2             	lea    -0xe(%ebp),%eax
8010677c:	0f 01 10             	lgdtl  (%eax)
  lgdt(c->gdt, sizeof(c->gdt));
}
8010677f:	c9                   	leave  
80106780:	c3                   	ret    
80106781:	eb 0d                	jmp    80106790 <switchkvm>
80106783:	90                   	nop
80106784:	90                   	nop
80106785:	90                   	nop
80106786:	90                   	nop
...
80106790:	a1 a4 55 11 80       	mov    0x801155a4,%eax
...
801067be:	0f 84 cd 00 00 00    	je     80106891 <switchuvm+0xe1>
    panic("switchuvm: no process");
  if(p->kstack == 0)
801067c4:	8b 46 08             	mov    0x8(%esi),%eax
801067c7:	85 c0                	test   %eax,%eax
801067c9:	0f 84 da 00 00 00    	je     801068a9 <switchuvm+0xf9>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
801067cf:	8b 7e 04             	mov    0x4(%esi),%edi
801067d2:	85 ff                	test   %edi,%edi
801067d4:	0f 84 c3 00 00 00    	je     8010689d <switchuvm+0xed>
    panic("switchuvm: no pgdir");

  pushcli();
801067da:	e8 41 db ff ff       	call   80104320 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801067df:	e8 2c ce ff ff       	call   80103610 <mycpu>
801067e4:	89 c3                	mov    %eax,%ebx
801067e6:	e8 25 ce ff ff       	call   80103610 <mycpu>
801067eb:	89 c7                	mov    %eax,%edi
801067ed:	e8 1e ce ff ff       	call   80103610 <mycpu>
801067f2:	83 c7 08             	add    $0x8,%edi
801067f5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801067f8:	e8 13 ce ff ff       	call   80103610 <mycpu>
801067fd:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106800:	ba 67 00 00 00       	mov    $0x67,%edx
80106805:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
8010680c:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106813:	c6 83 9d 00 00 00 99 	movb   $0x99,0x9d(%ebx)
8010681a:	83 c1 08             	add    $0x8,%ecx
8010681d:	c1 e9 10             	shr    $0x10,%ecx
80106820:	83 c0 08             	add    $0x8,%eax
80106823:	c1 e8 18             	shr    $0x18,%eax
80106826:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
8010682c:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80106833:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
...
80106839:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    panic("switchuvm: no pgdir");
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
8010683e:	e8 cd cd ff ff       	call   80103610 <mycpu>
80106843:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010684a:	e8 c1 cd ff ff       	call   80103610 <mycpu>
8010684f:	b9 10 00 00 00       	mov    $0x10,%ecx
80106854:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106858:	e8 b3 cd ff ff       	call   80103610 <mycpu>
8010685d:	8b 56 08             	mov    0x8(%esi),%edx
80106860:	8d 8a 00 10 00 00    	lea    0x1000(%edx),%ecx
80106866:	89 48 0c             	mov    %ecx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106869:	e8 a2 cd ff ff       	call   80103610 <mycpu>
8010686e:	66 89 58 6e          	mov    %bx,0x6e(%eax)
}
...
80106872:	b8 28 00 00 00       	mov    $0x28,%eax
80106877:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
8010687a:	8b 46 04             	mov    0x4(%esi),%eax
8010687d:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
8010688b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010688c:	e9 4f db ff ff       	jmp    801043e0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
80106891:	c7 04 24 16 77 10 80 	movl   $0x80107716,(%esp)
80106898:	e8 c3 9a ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
8010689d:	c7 04 24 41 77 10 80 	movl   $0x80107741,(%esp)
801068a4:	e8 b7 9a ff ff       	call   80100360 <panic>
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
801068a9:	c7 04 24 2c 77 10 80 	movl   $0x8010772c,(%esp)
801068b0:	e8 ab 9a ff ff       	call   80100360 <panic>
801068b5:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
801068d8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  ...
  if(sz >= PGSIZE)
801068db:	77 54                	ja     80106931 <inituvm+0x71>
...
801068f7:	e8 a4 db ff ff       	call   801044a0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
801068fc:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106902:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106907:	89 04 24             	mov    %eax,(%esp)
8010690a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010690d:	31 d2                	xor    %edx,%edx
8010690f:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80106916:	00 
80106917:	e8 94 fc ff ff       	call   801065b0 <mappages>
  memmove(mem, init, sz);
8010691c:	89 75 10             	mov    %esi,0x10(%ebp)
8010691f:	89 7d 0c             	mov    %edi,0xc(%ebp)
80106922:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
80106925:	83 c4 1c             	add    $0x1c,%esp
80106928:	5b                   	pop    %ebx
80106929:	5e                   	pop    %esi
8010692a:	5f                   	pop    %edi
8010692b:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
8010692c:	e9 0f dc ff ff       	jmp    80104540 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
80106931:	c7 04 24 55 77 10 80 	movl   $0x80107755,(%esp)
80106938:	e8 23 9a ff ff       	call   80100360 <panic>
...
80106950:	0f 85 98 00 00 00    	jne    801069ee <loaduvm+0xae>
...
8010695f:	eb 77                	jmp    801069d8 <loaduvm+0x98>
...
80106977:	76 5f                	jbe    801069d8 <loaduvm+0x98>
80106979:	8b 55 0c             	mov    0xc(%ebp),%edx
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
8010697c:	31 c9                	xor    %ecx,%ecx
8010697e:	8b 45 08             	mov    0x8(%ebp),%eax
80106981:	01 da                	add    %ebx,%edx
80106983:	e8 98 fb ff ff       	call   80106520 <walkpgdir>
80106988:	85 c0                	test   %eax,%eax
8010698a:	74 56                	je     801069e2 <loaduvm+0xa2>
...
8010698c:	8b 00                	mov    (%eax),%eax
    if(sz - i < PGSIZE)
      ...
      n = PGSIZE;
8010698e:	bf 00 10 00 00       	mov    $0x1000,%edi
80106993:	8b 4d 14             	mov    0x14(%ebp),%ecx
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
...
80106996:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
      ...
      n = PGSIZE;
8010699b:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
801069a1:	0f 42 fe             	cmovb  %esi,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
801069a4:	05 00 00 00 80       	add    $0x80000000,%eax
801069a9:	89 44 24 04          	mov    %eax,0x4(%esp)
801069ad:	8b 45 10             	mov    0x10(%ebp),%eax
801069b0:	01 d9                	add    %ebx,%ecx
801069b2:	89 7c 24 0c          	mov    %edi,0xc(%esp)
801069b6:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801069ba:	89 04 24             	mov    %eax,(%esp)
801069bd:	e8 ae af ff ff       	call   80101970 <readi>
801069c2:	39 f8                	cmp    %edi,%eax
801069c4:	74 a2                	je     80106968 <loaduvm+0x28>
      return -1;
  }
  return 0;
}
801069c6:	83 c4 1c             	add    $0x1c,%esp
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
801069e1:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
801069e2:	c7 04 24 6f 77 10 80 	movl   $0x8010776f,(%esp)
801069e9:	e8 72 99 ff ff       	call   80100360 <panic>
{
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
801069ee:	c7 04 24 10 78 10 80 	movl   $0x80107810,(%esp)
801069f5:	e8 66 99 ff ff       	call   80100360 <panic>
...
80106a0e:	0f 88 7e 00 00 00    	js     80106a92 <allocuvm+0x92>
    return 0;
  if(newsz < oldsz)
...
80106a17:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
80106a1a:	72 78                	jb     80106a94 <allocuvm+0x94>
    return oldsz;

  a = PGROUNDUP(oldsz);
80106a1c:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106a22:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106a28:	39 df                	cmp    %ebx,%edi
80106a2a:	77 4a                	ja     80106a76 <allocuvm+0x76>
80106a2c:	eb 72                	jmp    80106aa0 <allocuvm+0xa0>
80106a2e:	66 90                	xchg   %ax,%ax
    ...
    memset(mem, 0, PGSIZE);
80106a30:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106a37:	00 
80106a38:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106a3f:	00 
80106a40:	89 04 24             	mov    %eax,(%esp)
80106a43:	e8 58 da ff ff       	call   801044a0 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106a48:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
...
80106a5b:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80106a62:	00 
80106a63:	e8 48 fb ff ff       	call   801065b0 <mappages>
80106a68:	85 c0                	test   %eax,%eax
80106a6a:	78 44                	js     80106ab0 <allocuvm+0xb0>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80106a6c:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106a72:	39 df                	cmp    %ebx,%edi
80106a74:	76 2a                	jbe    80106aa0 <allocuvm+0xa0>
    mem = kalloc();
80106a76:	e8 35 ba ff ff       	call   801024b0 <kalloc>
    if(mem == 0){
80106a7b:	85 c0                	test   %eax,%eax
  ...
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
80106a7d:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106a7f:	75 af                	jne    80106a30 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106a81:	c7 04 24 8d 77 10 80 	movl   $0x8010778d,(%esp)
80106a88:	e8 c3 9b ff ff       	call   80100650 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
  ...
  if(newsz >= oldsz)
80106a8d:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106a90:	77 48                	ja     80106ada <allocuvm+0xda>
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      ...
      kfree(mem);
      return 0;
80106a92:	31 c0                	xor    %eax,%eax
    }
  }
  return newsz;
}
80106a94:	83 c4 1c             	add    $0x1c,%esp
80106a97:	5b                   	pop    %ebx
80106a98:	5e                   	pop    %esi
80106a99:	5f                   	pop    %edi
80106a9a:	5d                   	pop    %ebp
...
80106aa0:	83 c4 1c             	add    $0x1c,%esp
...
80106aaa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80106ab0:	c7 04 24 a5 77 10 80 	movl   $0x801077a5,(%esp)
80106ab7:	e8 94 9b ff ff       	call   80100650 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
  ...
  if(newsz >= oldsz)
80106abc:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106abf:	76 0d                	jbe    80106ace <allocuvm+0xce>
80106ac1:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106ac4:	89 fa                	mov    %edi,%edx
80106ac6:	8b 45 08             	mov    0x8(%ebp),%eax
80106ac9:	e8 62 fb ff ff       	call   80106630 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
      deallocuvm(pgdir, newsz, oldsz);
      kfree(mem);
80106ace:	89 34 24             	mov    %esi,(%esp)
80106ad1:	e8 2a b8 ff ff       	call   80102300 <kfree>
      return 0;
80106ad6:	31 c0                	xor    %eax,%eax
80106ad8:	eb ba                	jmp    80106a94 <allocuvm+0x94>
80106ada:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106add:	89 fa                	mov    %edi,%edx
80106adf:	8b 45 08             	mov    0x8(%ebp),%eax
80106ae2:	e8 49 fb ff ff       	call   80106630 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
      deallocuvm(pgdir, newsz, oldsz);
      return 0;
80106ae7:	31 c0                	xor    %eax,%eax
80106ae9:	eb a9                	jmp    80106a94 <allocuvm+0x94>
80106aeb:	90                   	nop
...
80106af3:	8b 55 0c             	mov    0xc(%ebp),%edx
80106af6:	8b 4d 10             	mov    0x10(%ebp),%ecx
80106af9:	8b 45 08             	mov    0x8(%ebp),%eax
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
80106afc:	39 d1                	cmp    %edx,%ecx
80106afe:	73 08                	jae    80106b08 <deallocuvm+0x18>
      kfree(v);
      *pte = 0;
    }
  }
...
80106b00:	5d                   	pop    %ebp
80106b01:	e9 2a fb ff ff       	jmp    80106630 <deallocuvm.part.0>
80106b06:	66 90                	xchg   %ax,%ax
80106b08:	89 d0                	mov    %edx,%eax
80106b0a:	5d                   	pop    %ebp
80106b0b:	c3                   	ret    
...
80106b18:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
80106b1b:	85 f6                	test   %esi,%esi
80106b1d:	74 59                	je     80106b78 <freevm+0x68>
80106b1f:	31 c9                	xor    %ecx,%ecx
80106b21:	ba 00 00 00 80       	mov    $0x80000000,%edx
80106b26:	89 f0                	mov    %esi,%eax
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106b28:	31 db                	xor    %ebx,%ebx
80106b2a:	e8 01 fb ff ff       	call   80106630 <deallocuvm.part.0>
80106b2f:	eb 12                	jmp    80106b43 <freevm+0x33>
80106b31:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106b38:	83 c3 01             	add    $0x1,%ebx
80106b3b:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
80106b41:	74 27                	je     80106b6a <freevm+0x5a>
    if(pgdir[i] & PTE_P){
80106b43:	8b 14 9e             	mov    (%esi,%ebx,4),%edx
80106b46:	f6 c2 01             	test   $0x1,%dl
80106b49:	74 ed                	je     80106b38 <freevm+0x28>
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106b4b:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106b51:	83 c3 01             	add    $0x1,%ebx
    if(pgdir[i] & PTE_P){
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106b54:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
80106b5a:	89 14 24             	mov    %edx,(%esp)
80106b5d:	e8 9e b7 ff ff       	call   80102300 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106b62:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
80106b68:	75 d9                	jne    80106b43 <freevm+0x33>
    if(pgdir[i] & PTE_P){
      char * v = P2V(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
  ...
  kfree((char*)pgdir);
80106b6a:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
80106b72:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106b73:	e9 88 b7 ff ff       	jmp    80102300 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106b78:	c7 04 24 c1 77 10 80 	movl   $0x801077c1,(%esp)
80106b7f:	e8 dc 97 ff ff       	call   80100360 <panic>
...
80106b98:	e8 13 b9 ff ff       	call   801024b0 <kalloc>
80106b9d:	85 c0                	test   %eax,%eax
80106b9f:	89 c6                	mov    %eax,%esi
80106ba1:	74 6d                	je     80106c10 <setupkvm+0x80>
    return 0;
  memset(pgdir, 0, PGSIZE);
80106ba3:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106baa:	00 
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106bab:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  pde_t *pgdir;
  struct kmap *k;
...
80106bbb:	e8 e0 d8 ff ff       	call   801044a0 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106bc0:	8b 53 0c             	mov    0xc(%ebx),%edx
80106bc3:	8b 43 04             	mov    0x4(%ebx),%eax
80106bc6:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106bc9:	89 54 24 04          	mov    %edx,0x4(%esp)
80106bcd:	8b 13                	mov    (%ebx),%edx
80106bcf:	89 04 24             	mov    %eax,(%esp)
80106bd2:	29 c1                	sub    %eax,%ecx
80106bd4:	89 f0                	mov    %esi,%eax
80106bd6:	e8 d5 f9 ff ff       	call   801065b0 <mappages>
80106bdb:	85 c0                	test   %eax,%eax
80106bdd:	78 19                	js     80106bf8 <setupkvm+0x68>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106bdf:	83 c3 10             	add    $0x10,%ebx
80106be2:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106be8:	72 d6                	jb     80106bc0 <setupkvm+0x30>
80106bea:	89 f0                	mov    %esi,%eax
...
80106bf4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
80106bf8:	89 34 24             	mov    %esi,(%esp)
80106bfb:	e8 10 ff ff ff       	call   80106b10 <freevm>
      return 0;
    }
  return pgdir;
}
...
80106c12:	eb d8                	jmp    80106bec <setupkvm+0x5c>
...
80106c23:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106c26:	e8 65 ff ff ff       	call   80106b90 <setupkvm>
80106c2b:	a3 a4 55 11 80       	mov    %eax,0x801155a4
// Switch h/w page table register to the kernel-only page table,
// for when no process is running.
void
switchkvm(void)
...
80106c4e:	e8 cd f8 ff ff       	call   80106520 <walkpgdir>
  if(pte == 0)
80106c53:	85 c0                	test   %eax,%eax
80106c55:	74 05                	je     80106c5c <clearpteu+0x1c>
    panic("clearpteu");
  *pte &= ~PTE_U;
80106c57:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
80106c5a:	c9                   	leave  
80106c5b:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106c5c:	c7 04 24 d2 77 10 80 	movl   $0x801077d2,(%esp)
80106c63:	e8 f8 96 ff ff       	call   80100360 <panic>
80106c68:	90                   	nop
...
80106c76:	83 ec 2c             	sub    $0x2c,%esp
  ...
  if((d = setupkvm()) == 0)
80106c79:	e8 12 ff ff ff       	call   80106b90 <setupkvm>
80106c7e:	85 c0                	test   %eax,%eax
80106c80:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106c83:	0f 84 b2 00 00 00    	je     80106d3b <copyuvm+0xcb>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106c89:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c8c:	85 c0                	test   %eax,%eax
80106c8e:	0f 84 9c 00 00 00    	je     80106d30 <copyuvm+0xc0>
80106c94:	31 db                	xor    %ebx,%ebx
80106c96:	eb 48                	jmp    80106ce0 <copyuvm+0x70>
...
80106ccc:	e8 df f8 ff ff       	call   801065b0 <mappages>
80106cd1:	85 c0                	test   %eax,%eax
80106cd3:	78 41                	js     80106d16 <copyuvm+0xa6>
  uint pa, i, flags;
  char *mem;
...
80106cdb:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106cde:	76 50                	jbe    80106d30 <copyuvm+0xc0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106ce0:	8b 45 08             	mov    0x8(%ebp),%eax
80106ce3:	31 c9                	xor    %ecx,%ecx
80106ce5:	89 da                	mov    %ebx,%edx
80106ce7:	e8 34 f8 ff ff       	call   80106520 <walkpgdir>
80106cec:	85 c0                	test   %eax,%eax
80106cee:	74 5b                	je     80106d4b <copyuvm+0xdb>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106cf0:	8b 30                	mov    (%eax),%esi
80106cf2:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106cf8:	74 45                	je     80106d3f <copyuvm+0xcf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106cfa:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106cfc:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106d02:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106d05:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106d0b:	e8 a0 b7 ff ff       	call   801024b0 <kalloc>
80106d10:	85 c0                	test   %eax,%eax
80106d12:	89 c6                	mov    %eax,%esi
80106d14:	75 82                	jne    80106c98 <copyuvm+0x28>
      goto bad;
  }
  return d;
...
bad:
  freevm(d);
80106d16:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106d19:	89 04 24             	mov    %eax,(%esp)
80106d1c:	e8 ef fd ff ff       	call   80106b10 <freevm>
  return 0;
...
80106d30:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106d33:	83 c4 2c             	add    $0x2c,%esp
80106d36:	5b                   	pop    %ebx
80106d37:	5e                   	pop    %esi
80106d38:	5f                   	pop    %edi
80106d39:	5d                   	pop    %ebp
...
80106d3d:	eb e4                	jmp    80106d23 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106d3f:	c7 04 24 f6 77 10 80 	movl   $0x801077f6,(%esp)
80106d46:	e8 15 96 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106d4b:	c7 04 24 dc 77 10 80 	movl   $0x801077dc,(%esp)
...
80106d6e:	e8 ad f7 ff ff       	call   80106520 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106ddc:	e8 5f d7 ff ff       	call   80104540 <memmove>
    len -= n;
    buf += n;
