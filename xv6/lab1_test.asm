...
free(void *ap)
{
 ...
 5e7:	89 10                	mov    %edx,(%eax)
  freep = p;
 5e9:	a3 a4 09 00 00       	mov    %eax,0x9a4
}
 5ee:	5b                   	pop    %ebx
 5ef:	5e                   	pop    %esi
 5f0:	5f                   	pop    %edi
 ...
 60f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 612:	a3 a4 09 00 00       	mov    %eax,0x9a4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 1d a4 09 00 00    	mov    0x9a4,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 679:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 67b:	3b 15 a4 09 00 00    	cmp    0x9a4,%edx
...
morecore(uint nu)
{
 ...
 6ad:	e8 ee fe ff ff       	call   5a0 <free>
  return freep;
 6b2:	8b 15 a4 09 00 00    	mov    0x9a4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6d4:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 6d7:	89 15 a4 09 00 00    	mov    %edx,0x9a4
      return (void*)(p + 1);
 ...
 6ec:	eb e9                	jmp    6d7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6ee:	c7 05 a4 09 00 00 a8 	movl   $0x9a8,0x9a4
 6f5:	09 00 00 
    base.s.size = 0;
 6f8:	ba a8 09 00 00       	mov    $0x9a8,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6fd:	c7 05 a8 09 00 00 a8 	movl   $0x9a8,0x9a8
 704:	09 00 00 
    base.s.size = 0;
 707:	c7 05 ac 09 00 00 00 	movl   $0x0,0x9ac
 70e:	00 00 00 
